...
from tests.core_model_dags.unit.core.core_listing_history.spark_jobs.conftest import (
    TEST_AUX_TABLE,
    TEST_LBC_TABLE,
...
class TestCoreListingHistoryEventDetection:
    ...
    def test_rent_status_and_status_reason_events_come_from_aux_table(
        ...
        rent_reason = [
            r
            for r in rows
            if r["event_name"] == "ev_status_reason"
    ...
    def test_sale_id_house_listing_always_uses_version_zero_suffix(
        ...
        sale_rows = [
            r for r in result.collect() if r["business_context"] == "SALE"
        ]
