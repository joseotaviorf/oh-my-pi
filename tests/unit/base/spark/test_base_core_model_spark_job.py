...
"""
    ...
    def test_run_method_includes_schema_validation(
        ...
        with patch.object(job_instance, "parse_args") as mock_parse_args, patch.object(
            job_instance, "initialize_spark_session"
        ) as mock_init_spark, patch.object(
            job_instance, "create_core_model"
        ) as mock_create_model, patch.object(
            job_instance, "validate_dataframe_schema"
        ) as mock_validate_schema, patch.object(
            job_instance, "run_pipeline"
    ...
    def test_schema_validation_logs_debug_information(
        ...
        with patch(
            "bietlejuice.base.service.dag_packages_path_service.DAGPackagesPathService._read_dag_package_file_from_s3"
        ) as mock_read_file, patch.object(job_instance, "logger") as mock_logger:
    ...
    def test_send_schema_validation_webhook_success(self, job_instance):
        ...
        ) as mock_gchat_service, patch(
            "bietlejuice.base.spark.base_core_model_spark_job.Message"
        ) as mock_message_class, patch.object(
            job_instance, "logger"
        ) as mock_logger:
    ...
    def test_validate_dataframe_schema_calls_webhook_on_failure(
        ...
        with patch(
            "bietlejuice.base.service.dag_packages_path_service.DAGPackagesPathService._read_dag_package_file_from_s3"
        ) as mock_read_file, patch.object(
