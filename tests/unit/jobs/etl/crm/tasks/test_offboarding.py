...
class TestCRMTasksOffboarding(object):
    ...
    def test_move_fact_to_staging(self, mock__move_fact_to_staging, offboarding):
        ...
        append_query_name = CRMTasksOffboarding.QUERY_FILENAMES['staging']
        manual_workgroup_ids = CRMTasksOffboarding.MANUAL_TASK_WORKGROUP_IDS
    ...
    def test_append_fact_to_dw(self, mock__append_fact_to_dw, offboarding):
        # arrange
        table_name = CRMTasksOffboarding.TABLE_NAMES['fact']
        append_query_name = CRMTasksOffboarding.QUERY_FILENAMES['prod']
