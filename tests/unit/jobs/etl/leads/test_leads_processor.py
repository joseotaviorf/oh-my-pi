...
class TestLeadsProcessor(object):
    def test_get_unit_divisor_none(self, lead_processor):
        # arrange
        unit = None
        expected_result = None

        # act
        result = lead_processor.get_unit_divisor(unit=unit)

        # assert
        assert result is expected_result

    def test_get_unit_divisor_not_none(self, lead_processor):
        # arrange
        unit = 'week'
        expected_result = 7.0
    ...
    def test_get_polygons_not_none(self, lead_processor):
        # arrange
        lead_processor._poly = 'Lorem Ipsum'
        expected_result = 'Lorem Ipsum'

        # act
        result = lead_processor.get_polygons()
    ...
    def test_get_polygons_none(self, mock_from_db_query, mock_get_query_from_file_name, lead_processor):
        # arrange
        lead_processor._poly = None
    ...
    def test_check_coverage(self, lat, lng, expected, lead_processor):
        # act
        result = lead_processor.check_coverage(lat, lng)
    ...
    def test_check_coverage_poly_none(self, mock_get_polygons, lat, lng, expected, lead_processor):
        # act
        result = lead_processor.check_coverage(lat, lng)
    ...
    def test_get_reprocessed(self, mock_from_db_query, mock_get_query_from_file_name, lead_processor):
        # arrange
        expected_result = petl.todataframe([[1]])

        # act
        result = lead_processor.get_reprocessed()
    ...
    @mock.patch.object(BaseETL, 'from_db_query', return_value=list(petl.data([['col'], [1]])))
    def test_get_contacts(self, mock_from_db_query, mock_get_query_from_file_name, lead_processor):
        # arrange
        week_interval = 1
        status_in = None
        reason_in = None
        ...
        # act
        result = lead_processor.get_contacts(week_interval, status_in, reason_in, statuses, reasons)
    ...
    def test_read_leads(self, mock__build_time_interval_filter, mock_from_db_query, lead_processor):
        # arrange
        origin = ['o1']
        status = ['s1']
        reason = ['r1']
        ...
        # act
        result = lead_processor.read_leads(origin=origin, status=status, reason=reason, interval=interval, unit=unit)
    ...
    def test__build_leads_list_with_no_key_matching(self, lead_processor):
        # arrange
        leads = pd.DataFrame(data=[1], columns=['id'])

        # act & assert
        with pytest.raises(KeyError):
            result = lead_processor._build_leads_list(leads)

    def test__build_leads_list_with_key_matching(self, lead_processor):
        # arrange
    ...
    def test_send_leads(self, mock__build_leads_list, mock_publish_messages, lead_processor):
        # arrange
        leads = pd.DataFrame(data=[1], columns=['id'])

        # act
        lead_processor.send_leads(leads=leads)
    ...
    def test__build_categorical_filter_categories_none(self, lead_processor, categories, expected):
        # arrange
        column = None

        # act
        result = lead_processor._build_categorical_filter(column=column, categories=categories)
    ...
    @pytest.mark.parametrize('column, categories, expected', [('0', ['0', '1'], """0 in ('0', '1')\n"""),
                                                              ('0', ['1', '2'], """0 in ('1', '2')\n""")])
    def test___build_categorical_filter_categories_list(self, lead_processor, column, categories, expected):
        # act
        result = lead_processor._build_categorical_filter(column=column, categories=categories)
    ...
    def test__build_time_interval_filter_u_none(self, mock_get_unit_divisor, lead_processor):
        # arrange
        column = None
        interval = None
        unit = None
        ...
        # act
        result = lead_processor._build_time_interval_filter(column=column, interval=interval, unit=unit)
    ...
    def test__build_time_interval_filter_interval_none(self, mock_get_unit_divisor, interval, expected, lead_processor):
        # arrange
        column = None
        unit = 'day'
    ...
    @mock.patch.object(LeadsProcessor, 'get_unit_divisor', return_value=1.0)
    def test__build_time_interval_filter_interval_not_none(self, mock_get_unit_divisor, lead_processor):
        # arrange
        interval = ['1', '2']
        column = None
        unit = 'day'
    ...
    @mock.patch.object(LeadsProcessor, 'get_unit_divisor', return_value=1.0)
    def test__build_time_interval_filter_interval_one_item_only(self, mock_get_unit_divisor, lead_processor):
        # arrange
        interval = ['1']
        column = None
        unit = 'day'
