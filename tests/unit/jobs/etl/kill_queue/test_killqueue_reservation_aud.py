...
class TestKillQueueReservationAud(object):
    ...
    def test_extract_data_and_move_to_raw(self, mock__extract_data_and_move_to_raw, reservation_aud):
        # arrange
        table_name = reservation_aud.table_name

        # act
        reservation_aud.extract_data_and_move_to_raw()
    ...
    def test_move_data_from_raw_to_clean(self, mock__move_data_from_raw_to_clean, reservation_aud):
        # arrange
        table_name = reservation_aud.table_name

        # act
        reservation_aud.move_data_from_raw_to_clean()
