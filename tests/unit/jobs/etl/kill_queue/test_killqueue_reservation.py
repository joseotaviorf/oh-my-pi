...
class TestKillQueueReservation(object):
    ...
    def test_extract_data_and_move_to_raw(self, mock__extract_data_and_move_to_raw, reservation):
        # arrange
        table_name = reservation.table_name

        # act
        reservation.extract_data_and_move_to_raw()
    ...
    def test_move_data_from_raw_to_clean(self, mock__move_data_from_raw_to_clean, reservation):
        # arrange
        table_name = reservation.table_name

        # act
        reservation.move_data_from_raw_to_clean()
