...
class TestKillQueueHouse(object):
    ...
    def test_extract_data_and_move_to_raw(self, mock__extract_data_and_move_to_raw, house):
        # arrange
        table_name = house.table_name

        # act
        house.extract_data_and_move_to_raw()
    ...
    def test_move_data_from_raw_to_clean(self, mock__move_data_from_raw_to_clean, house):
        # arrange
        table_name = house.table_name

        # act
        house.move_data_from_raw_to_clean()
