...
class TestConfigurationService:
    ...
    @mock.patch.dict(os.environ, {"ENVIRONMENT": "integration_env"})
    def test_load_confs_for_some_dag(self, mock_get_dag_parent_path, mock_root_constant):
    ...
    @mock.patch.object(DAGPackagesPathService, "get_dag_parent_path")
    @mock.patch.dict(os.environ, {"ENVIRONMENT": "integration_env"})
    def test_load_confs_for_some_dag_spark_jobs(self, mock_get_dag_parent_path, mock_root_constant):
