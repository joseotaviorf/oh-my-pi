...
from pyspark.sql.functions import lit, current_timestamp, explode
...
class TestSchemaContract(unittest.TestCase):
    ...
    def test_real_explode_and_flatten_actions_schema(self):
        ...
        self.assertEqual(len(actual_columns), 25,
                        f"Expected 25 columns, got {len(actual_columns)}")
    ...
    def test_real_explode_rules_schema(self):
        ...
        self.assertIn("rule", result_df.columns, "Expected 'rule' column after exploding rules")
    ...
    def test_column_count_contract(self):
        ...
        self.assertEqual(len(result_columns), expected_column_count,
    ...
    def test_mandatory_columns_contract(self):
        ...
        for mandatory_col in mandatory_columns:
            self.assertIn(mandatory_col, result_columns,
    ...
    def test_timestamp_column_contract(self):
        ...
        self.assertIn("generated_at", result_columns,
    ...
    def test_action_template_columns_contract(self):
        ...
        for template_col in expected_template_columns:
            self.assertIn(template_col, result_columns,
    ...
    def test_scope_columns_contract(self):
        ...
        for scope_col in expected_scope_columns:
            self.assertIn(scope_col, result_columns,
    ...
    def _validate_sample_structure(self, sample_data):
        ...
        if sample_data["rules"]:
            ...
            expected_scope_fields = [
                "business_context", "category", "company", "context",
                "cost_center", "journey_step", "line", "profile", "team"
            ]
            ...
            if rule["actions"]:
                ...
                expected_action_fields = [
                    "action_id", "notification_type", "profile",
                    "reason", "deep_link", "templates"
                ]
                ...
                expected_template_fields = [
                    "subject_template", "body_template", "body_template_path",
                    "subject_content", "body_content"
                ]
...
class TestSchemaEvolution(unittest.TestCase):
    ...
    def test_new_column_addition_contract(self):
        ...
        self.assertIn("generated_at", expected_columns,
    ...
    def test_backward_compatibility_contract(self):
        ...
        original_columns = [
            ...
            "context", "cost_center", "journey_step", "line", "rule_profile", "team",
            "action_id", "notification_type", "action_profile",
            "reason", "deep_link",
            "subject_template", "body_template",
            "body_template_path", "subject_content",
            "body_content"
        ]
        ...
        for original_col in original_columns:
            self.assertIn(original_col, current_columns,
    ...
    def _get_current_schema_columns(self):
        ...
        return [
            "generated_at", "rule_id", "status", "business_context", "category", "company",
            "context", "cost_center", "journey_step", "line", "rule_profile", "team",
            "action_id", "notification_type", "action_profile",
            "reason", "deep_link",
            "subject_template", "body_template",
