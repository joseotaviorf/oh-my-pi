...
aws s3 cp s3://artifacts.s3.data.quintoandar.com.br/inmetro/inmetro-2.1.1-py3-none-any.whl /inmetro-2.1.1-py3-none-any.whl
...
/databricks/python/bin/pip install '/inmetro-2.1.1-py3-none-any.whl[pydeequ]'
