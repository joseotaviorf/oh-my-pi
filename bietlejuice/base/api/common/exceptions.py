...
class APIException(Exception):
    ...
    def __init__(
        ...
        status_code=None,
        response_text=None,
        response_log_char_limit: int = 300,
    ):
        ...
        if response_text:
            # Show only the first N characters to avoid flooding the logs
            details.append(f"Response Body: {response_text[:response_log_char_limit]}")
