...
1. Data lake raw:
    - All gsheets defined in `gsheets_several_daily_runs_files.yaml`, available [here](https://github.com/quintoandar/bi-etl-ejuice/blob/master/bietlejuice/dags/gsheets/gsheets_files.yaml)
