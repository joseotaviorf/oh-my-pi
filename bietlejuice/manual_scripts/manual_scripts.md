...
### Scripts:
    - load_full_quintoandar_into_datalake.py:
        ...
        the sync with Hive. These tables have queries stored in this [folder](https://github.com/quintoandar/bi-etl-ejuice/tree/master/bietlejuice/db/datalake/queries/quintoandar).

    -load_full_public_into_dw.py:
        Load tables with potential common use among different contexts. From S3 to the sync with Hive. These tables have queries stored in this [folder](https://github.com/quintoandar/bi-etl-ejuice/tree/master/bietlejuice/db/dw/queries/public).
