...
from bietlejuice.qube.jobs.common.logging_config import setup_logging, get_logger
...
def _process_window(
    ...
    _write_output(
        result_df, conf, meas_config.entity, meas_config.name, window_days, hi
    )
...
def _write_output(
    ...
    target_database_name = "qube_measures"
