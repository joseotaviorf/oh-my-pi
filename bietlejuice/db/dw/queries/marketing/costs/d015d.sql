...
base AS (
    ...
    WHERE
        LOWER(JSON_EXTRACT_PATH_TEXT(user_properties, 'utm_medium')) = 'retargeting'
        AND LOWER(JSON_EXTRACT_PATH_TEXT(user_properties, 'utm_source')) = 'google'
