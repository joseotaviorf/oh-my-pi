...
select
 ...
 sum(coalesce(p.total_daily_prospects, 0)) as total_monthly_prospects,
 sum(coalesce(q.total_daily_qualifieds, 0)) as total_monthly_qualifieds,
 sum(coalesce(op.total_daily_opportunities, 0)) as total_monthly_opportunities,
...
select
	 ...
	 coalesce(supply.total_monthly_prospects, 0) as total_monthly_prospects,
     coalesce(supply.total_monthly_qualifieds, 0) as total_monthly_qualifieds,
     coalesce(supply.total_monthly_opportunities, 0) as total_monthly_opportunities,
