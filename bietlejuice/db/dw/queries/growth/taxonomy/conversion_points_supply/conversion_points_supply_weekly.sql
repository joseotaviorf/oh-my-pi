...
select
 ...
 sum(coalesce(p.total_daily_prospects, 0)) as total_weekly_prospects,
 sum(coalesce(q.total_daily_qualifieds, 0)) as total_weekly_qualifieds,
 sum(coalesce(op.total_daily_opportunities, 0)) as total_weekly_opportunities,
...
select
	 ...
	 coalesce(supply.total_weekly_prospects, 0) as total_weekly_prospects,
     coalesce(supply.total_weekly_qualifieds, 0) as total_weekly_qualifieds,
     coalesce(supply.total_weekly_opportunities, 0) as total_weekly_opportunities,
