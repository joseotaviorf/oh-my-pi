with all_dates as (
  ...
  order by coalesce(dr.region_code, ''), date_part('year', dp.publication_date), date_part('month', dp.publication_date), date_part('week', dp.publication_date), date_part('day', dp.publication_date)
),
...
all_dates_last_month as (
	...
	where date_part('year', dp.publication_date) = date_part('year', add_months(current_date, -1))
 	...
 	group by coalesce(dr.region_code, ''), date_part('year', dp.publication_date), date_part('month', dp.publication_date)
  order by coalesce(dr.region_code, ''), date_part('year', dp.publication_date), date_part('month', dp.publication_date)
),
all_dates_last_year as (
  ...
  where date_part('year', dp.publication_date) = date_part('year', add_months(current_date, -12))
	...
	group by coalesce(dr.region_code, ''), date_part('year', dp.publication_date)
	order by coalesce(dr.region_code, ''), date_part('year', dp.publication_date)
),
