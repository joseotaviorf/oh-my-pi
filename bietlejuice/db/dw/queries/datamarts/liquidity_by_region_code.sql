...
all_regions AS (
  SELECT
    DISTINCT city_group, region_code, house_bedrooms_category, min_bedrooms, max_bedrooms
...
FROM all_regions r
LEFT JOIN liquidity_metrics l ON r.city_group = l.city_group AND r.region_code = l.region_code AND r.house_bedrooms_category = l.house_bedrooms_category
WHERE
