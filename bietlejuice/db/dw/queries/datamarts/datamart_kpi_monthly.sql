...
left join ongoing_listings ol
	on ol.month_start = vb.month_start and ol.city_name = vb.city_name
...
full outer join bookers b
  on b.booking_created_month = dm.month_date and dr.city_name = b.city_name
full outer join listing_to_contract_signed l2cs
  on l2cs.publication_month = dm.month_date and dr.city_name = l2cs.city_name
full outer join visits_booked_per_ongoing_listings vb_ol
  on vb_ol.month_start = dm.month_date and dr.city_name = vb_ol.city_name
