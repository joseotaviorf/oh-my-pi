...
SELECT
    ...
    NULL AS hub_offer,
    CASE
        WHEN datediff('week',DATE_TRUNC('week',DATE(slf.sk_qualified_date)),DATE_TRUNC('week',DATE(NULLIF(slf.sk_available_qualified_date,-1)))) < 20
            THEN 'W'||datediff('week',DATE_TRUNC('week',DATE(slf.sk_qualified_date)),DATE_TRUNC('week',DATE(NULLIF(slf.sk_available_qualified_date,-1))))
        WHEN datediff('week',DATE_TRUNC('week',DATE(slf.sk_qualified_date)),DATE_TRUNC('week',DATE(NULLIF(slf.sk_available_qualified_date,-1)))) >= 20
            THEN 'W20+'
    END AS weeks_conversion,
    NULL::BIGINT AS p2fc,
...
SELECT
    ...
    NULL AS hub_offer,
    CASE
        WHEN datediff('week',DATE_TRUNC('week',DATE(slf.sk_available_qualified_date)),DATE_TRUNC('week',DATE(NULLIF(slf.sk_opportunity_date,-1)))) < 20
            THEN 'W'||datediff('week',DATE_TRUNC('week',DATE(slf.sk_available_qualified_date)),DATE_TRUNC('week',DATE(NULLIF(slf.sk_opportunity_date,-1))))
        WHEN datediff('week',DATE_TRUNC('week',DATE(slf.sk_available_qualified_date)),DATE_TRUNC('week',DATE(NULLIF(slf.sk_opportunity_date,-1)))) >= 20
            THEN 'W20+'
    END AS weeks_conversion,
    NULL::BIGINT AS p2fc,
