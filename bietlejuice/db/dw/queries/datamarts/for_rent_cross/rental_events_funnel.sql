...
LEFT JOIN (SELECT distinct city_group, region_code, country_code FROM dim_region) dr
...
LEFT JOIN house_listing_daily_info ciq
  ...
  AND ciq.sk_date  IN (rf.sk_contract_annulment_date, rf.sk_contract_signed_date, rf.sk_contract_created_date, rf.sk_last_doc_analysis_approved, rf.sk_credit_analysis_approved_date, rf.sk_credit_analysis_end_date,
