...
select
    ...
    CAST(d.week_start AS VARCHAR) AS week_start,
    CAST(d.slot AS VARCHAR) AS slot,
    CAST(d.hour AS VARCHAR) AS hour,
    CAST(d.faixa AS VARCHAR) AS faixa,
    CAST(sum(unique_bookings) AS VARCHAR) as sum_bookings,
    CAST(sum(enc.share_encaixes_total) AS VARCHAR) as sum_encaixes,
    CAST(sum(enc.share_encaixes_realizados) AS VARCHAR) as sum_encaixes_realized,
    CAST(sum(enc.share_encaixes_nao_realizados) AS VARCHAR) as sum_encaixes_not_realized,
    CAST(sum(enc.share_nao_realizado_cant_find_another_agent) AS VARCHAR) as sum_encaixes_nao_realizado_cant_find_another_agent,
    CAST(sum(enc.share_encaixes_nao_realizados_por_agenda) AS VARCHAR) as sum_encaixes_nao_realizados_por_agenda,
    CAST(sum(enc.share_encaixes_nao_realizados_por_bloqueio) AS VARCHAR) as sum_encaixes_nao_realizados_por_bloqueio,
    CAST(sum(enc.share_encaixes_nao_realizados_por_suspensao) AS VARCHAR) as sum_encaixes_nao_realizados_por_suspensao,
    CAST(sum(enc.share_encaixes_nao_realizados_por_bloqueio_suspensao) AS VARCHAR) as sum_encaixes_nao_realizados_por_bloqueio_suspensao,
