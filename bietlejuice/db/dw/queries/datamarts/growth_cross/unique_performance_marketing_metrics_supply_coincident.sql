...
costs_targets_results_combined AS (
    ...
    SELECT 
        ...
        SUM(0::FLOAT) AS available_qualifieds_target_sale,
        ...
        SUM(0::FLOAT) AS available_qualifieds_target_rental,
...
SELECT
    ...
    SUM(CAST(available_qualifieds_target_sale AS FLOAT8)) AS available_qualifieds_target_sale,
    ...
    SUM(CAST(available_qualifieds_target_rental AS FLOAT8)) AS available_qualifieds_target_rental,
