DROP TABLE IF EXISTS crm.dim_ungrouped_manual_task;
CREATE TABLE crm.dim_ungrouped_manual_task (
...
ALTER TABLE crm.dim_ungrouped_manual_task OWNER TO airflow;
