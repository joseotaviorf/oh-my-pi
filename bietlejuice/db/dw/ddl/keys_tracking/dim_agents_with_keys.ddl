...
CREATE TABLE keys_tracking.dim_agents_with_keys (
    ...
    days_attribution_to_first_vc DECIMAL(7, 2),
    days_attribution_to_first_vc_agent DECIMAL(7, 2),
    days_cs_to_return DECIMAL(7, 2),
    days_publication_to_attribution DECIMAL(7, 2),
