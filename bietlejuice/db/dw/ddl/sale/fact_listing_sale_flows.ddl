DROP TABLE IF EXISTS sale.fact_listing_sale_flows;

CREATE TABLE IF NOT EXISTS sale.fact_listing_sale_flows
(
    ods_id BIGINT,
...
ALTER TABLE sale.fact_listing_sale_flows OWNER TO databricks;