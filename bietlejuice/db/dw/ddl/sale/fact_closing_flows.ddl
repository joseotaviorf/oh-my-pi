...
CREATE TABLE sale.fact_closing_flows (
  ...
  sk_payment_allowed_date BIGINT,
  sk_down_payment_date BIGINT,
  sk_diligence_buyer_sent_at BIGINT,
  sk_diligence_seller_sent_at BIGINT,
  --
  ...
  days_sale_agreement_signed_to_financing_ended INTEGER,
  ...
  days_credit_analysis_ended_to_financing_started INTEGER,
  days_financing_started_to_bank_legal_analysis_started INTEGER,
