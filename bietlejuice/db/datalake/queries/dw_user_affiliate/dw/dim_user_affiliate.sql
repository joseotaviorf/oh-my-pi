...
SELECT -- [ODS] This table was migrated from ODS flow and needs a future refactoring to remove castings and renamings
  ...
  NULLIF(atax.origin, '') AS origin,
  NULLIF(atax.affiliate_type, '') AS type,
  NULLIF(atax.marketing_city_group, '') AS marketing_city_group,
  NULLIF(atax.regional, '') AS regional,
  NULLIF(atax.tracking_source, '') AS tracking_source,
  NULLIF(atax.tracking_medium, '') AS tracking_medium,
  NULLIF(atax.tracking_campaign, '') AS tracking_campaign,
  NULLIF(atax.tracking_content, '') AS tracking_content,
  NULLIF(atax.tracking_term, '') AS tracking_term,
  NULLIF(atax.tracking_platform, '') AS tracking_platform,
  NULLIF(atax.tracking_device_type, '') AS tracking_device_type,
  NULLIF(atax.tracking_country, '') AS tracking_country,
  NULLIF(atax.tracking_state, '') AS tracking_state,
  NULLIF(atax.tracking_city, '') AS tracking_city,
