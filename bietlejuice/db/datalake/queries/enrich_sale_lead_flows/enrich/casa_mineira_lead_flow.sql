...
SELECT
    uu.id_secretariat_client,
    fsc.id_region_secretariat_contact AS id_first_region_contact_prospect,
    lsc.id_region_secretariat_contact AS id_last_region_contact_prospect,
    fb.id_region_booking AS id_first_region_booking,
    lb.id_region_booking AS id_last_region_booking,
    fo.id_region_offer AS id_first_region_offer,
    lo.id_region_offer AS id_last_region_offer,
    fsc.id_house_5a AS id_first_house_5a_secretariat_contact,
    fsc.id_house_cm AS id_first_house_cm_secretariat_contact,
    lsc.id_house_5a AS id_last_house_5a_secretariat_contact,
    lsc.id_house_cm AS id_last_house_cm_secretariat_contact,
    fb.id_house_5a AS id_first_house_5a_booking,
    fb.id_house_cm AS id_first_house_cm_booking,
    lb.id_house_5a AS id_last_house_5a_booking,
    lb.id_house_cm AS id_last_house_cm_booking,
    fo.id_house_cm AS id_first_house_cm_offer,
    lo.id_house_cm AS id_last_house_cm_offer,
    fc.id_house_cm AS id_first_house_cm_sale_agreement,
    lc.id_house_cm AS id_last_house_cm_sale_agreement,
    uu.list_emails,
