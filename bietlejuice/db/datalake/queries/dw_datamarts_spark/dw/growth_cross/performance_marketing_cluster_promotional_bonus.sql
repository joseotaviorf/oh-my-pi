...
promotional_bonus_cluster_targets AS (
    ...
    FROM
        datalake_gsheets_clean.promotional_bonus_cluster_targets pbct
...
promotional_bonus_user_cluster_targets AS (
    ...
    FROM
        datalake_gsheets_clean.promotional_bonus_user_cluster_targets pbut
        JOIN dw_public.dim_date dd
...
listings AS (
    ...
    base_listings AS (
        SELECT
            ...
            id_house,
            listing_date,
            DATE_FORMAT(listing_date, 'yyyy/MM') AS year_month,
