...
SELECT DISTINCT
    ...
    CAST(cd.number_of_departments AS INTEGER) AS number_of_departments,
    CAST(cd.number_of_segments AS INTEGER) AS number_of_segments,  
    ...
    CAST(cd.total_minutes_talk_time AS FLOAT) AS total_minutes_talk_time,
