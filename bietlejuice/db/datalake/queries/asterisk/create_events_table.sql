...
union select * from event_set_queue_num where id_call is not null and id_stage is not null and value_event is not null
union select * from event_start_attendance where id_call is not null and id_stage is not null 
union select * from event_answer_agent where id_call is not null and id_stage is not null
union select * from event_key_typed where id_call is not null and id_stage is not null
union select * from event_set_destination where id_call is not null and id_stage is not null and value_event is not null
union select * from event_audio_message where id_call is not null and id_stage is not null and value_event is not null
;