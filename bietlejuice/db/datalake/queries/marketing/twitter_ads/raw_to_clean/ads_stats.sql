...
(
	coalesce(cast(all_on_twitter_billed_charge_local_micro[1] AS decimal(12, 2)), 0) +
	coalesce(cast(publisher_network_segment_billed_charge_local_micro[1] AS decimal(12, 2)), 0)
