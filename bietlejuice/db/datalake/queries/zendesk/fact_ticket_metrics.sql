...
select
    t.sk_ticket,
    coalesce(c1.sk_house_listing, t.sk_house_listing) as sk_house_listing,
    coalesce(c1.sk_contract, t.sk_contract) as sk_contract,
    coalesce(c1.sk_client, -1) as sk_client,
    coalesce(c1.sk_owner, c2.sk_owner, -1) as sk_owner,
