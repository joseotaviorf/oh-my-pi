...
SELECT -- [ODS] This table was migrated from ODS flow and needs a future refactoring to remove castings and renamings
  ...
  CAST(contract_b2b.administration_split_percentage AS DECIMAL(5, 2)) AS administration_split_percentage,
  CAST(contract_b2b.brokerage_split_percentage AS DECIMAL(5, 2)) AS brokerage_split_percentage,
