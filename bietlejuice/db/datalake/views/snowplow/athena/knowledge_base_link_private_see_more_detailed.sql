DROP VIEW IF EXISTS datalake_snowplow_raw_prod.knowledge_base_link_private_see_more_detailed;
CREATE OR REPLACE VIEW datalake_snowplow_raw_prod.knowledge_base_link_private_see_more_detailed AS
WITH event_knowledge_base_link_private_see_more AS (
    SELECT 
    ...
    WHERE 
		vendor = 'magiclink'
      	AND event = 'knowledge_base_link_private_see_more'
...
SELECT 
    ...
    day
FROM 
	event_knowledge_base_link_private_see_more
;