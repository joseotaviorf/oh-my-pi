DROP VIEW IF EXISTS datalake_snowplow_raw_prod.open_ticket_transfer_error_detailed;
CREATE OR REPLACE VIEW datalake_snowplow_raw_prod.open_ticket_transfer_error_detailed AS
WITH event_open_ticket_transfer_error AS (
    SELECT 
    ...
    WHERE 
        vendor = 'magiclink'
        AND event = 'open_ticket_transfer_error'
...
SELECT 
    ...
    day
FROM 
    event_open_ticket_transfer_error
;