DROP VIEW IF EXISTS datalake_snowplow_raw_prod.ticket_tags_select_tag_detailed;
CREATE OR REPLACE VIEW datalake_snowplow_raw_prod.ticket_tags_select_tag_detailed AS
WITH event_ticket_tags_select_tag AS (
    SELECT 
    ...
    WHERE 
        vendor = 'magiclink'
        AND event = 'ticket_tags_select_tag'
...
SELECT 
    ...
    json_extract_scalar(event_json, '$.data.data.event.selected_tag') AS selected_tag,
