DROP VIEW IF EXISTS datalake_snowplow_raw_prod.knowledge_base_click_search_bar_detailed;
CREATE OR REPLACE VIEW datalake_snowplow_raw_prod.knowledge_base_click_search_bar_detailed AS
WITH event_knowledge_base_click_search_bar AS (
    SELECT 
    ...
    WHERE 
        vendor = 'magiclink'
        AND event = 'knowledge_base_click_search_bar'
...
SELECT 
    ...
    day
FROM 
    event_knowledge_base_click_search_bar
;