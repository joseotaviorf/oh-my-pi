drop table if exists datalake_raw.zendesk_ticket_audits;
create external table if not exists datalake_raw.zendesk_ticket_audits (
    id string,
    ticket_id string,
...
location
  's3://5a-datalake/raw/zendesk_ticket_audits/ticket_audits';