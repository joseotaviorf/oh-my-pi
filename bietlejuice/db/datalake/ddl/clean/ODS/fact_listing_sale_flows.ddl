drop table if exists datalake_clean.ods_fact_listing_sale_flows;
create external table datalake_clean.ods_fact_listing_sale_flows (
  ods_id string,
...
location 's3://5a-datalake/clean/ods/listing_sale_flows'
tblproperties (
