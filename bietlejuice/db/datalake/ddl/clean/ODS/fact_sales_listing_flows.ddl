...
create external table datalake_clean.ods_sale_fact_listing_flows (
	...
	sk_last_task_created_date string,
	sk_last_task_closed_date string,
	sk_first_contact_date string,
	...
	hours_lead_to_first_contact string,
	hours_prospect_to_first_contact string,
	...
	days_lead_to_first_contact string,
	days_prospect_to_first_contact string,
	...
	mkt_medium string,
	mkt_source string,
	ts_opt_out_sale string,
	lead_context_origin string,
	listing_rent_status string,
	ts_load string
)
...
location 's3://5a-datalake/clean/ods/sale_listing_flows'
tblproperties (
