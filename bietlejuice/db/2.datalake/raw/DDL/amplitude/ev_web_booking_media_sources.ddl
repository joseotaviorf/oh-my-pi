DROP TABLE amplitude.ev_web_booking_media_sources;
CREATE EXTERNAL TABLE amplitude.ev_web_booking_media_sources (
    id bigint,
	app string,
	event_type string,
	uuid string,
...
LOCATION 's3://5a-amplitude-events/app=160023/event_type=Confirmation-Visit_confirmed/';
MSCK REPAIR TABLE amplitude.ev_web_booking_media_sources;