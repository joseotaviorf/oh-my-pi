DROP TABLE amplitude.ev_ios_booking_media_sources;
CREATE EXTERNAL TABLE amplitude.ev_ios_booking_media_sources (
    id bigint,
	app string,
	event_type string,
	uuid string,
...
LOCATION 's3://5a-amplitude-events/app=156118/event_type=Confirmation-Visit_confirmed/';
MSCK REPAIR TABLE amplitude.ev_ios_booking_media_sources;