...
select
	...
	((bl.street is not null) and (bl.street_number is not null) and (bl.neighborhood is not null) and (bl.lat is not null and bl.lng is not null)) as full_address_flg,
	...
	date_diff('day', bl.dt_first_seen, dt_last_seen) as days_seen,
	date_diff('day', bl.dt_last_seen, dt_last_run) as days_unseen,
