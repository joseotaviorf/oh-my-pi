			...
			from (
				...
				from (
					select
					  ...
					  if(a.fupVisita is null,
					     false,
					     if((SELECT absenceReason FROM ebdb.Visitor v where v.agendamento_id=a.id and type='Agent' limit 1)= 'Absent',false,true)) as visit_performed,
