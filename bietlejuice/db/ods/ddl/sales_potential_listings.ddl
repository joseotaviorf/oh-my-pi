drop table public.sales_potential_listings;
create table public.sales_potential_listings (
...
CREATE INDEX sales_pot_list_lead_id_idx ON public.sales_potential_listings USING btree (lead_id);
CREATE INDEX sales_pot_list_region_id_idx ON public.sales_potential_listings USING btree (region_id);
CREATE INDEX sales_pot_list_usuario_que_cadast_id_idx ON public.sales_potential_listings USING btree (house_usuario_que_cadastrou_id);