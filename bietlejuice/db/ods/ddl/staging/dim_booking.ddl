...
CREATE TABLE staging.dim_booking (
  ...
  ts_scheduling_brz TIMESTAMP WITHOUT TIME ZONE,
  ts_cancel_brz TIMESTAMP WITHOUT TIME ZONE,
  ts_created_brz TIMESTAMP WITHOUT TIME ZONE,
  ts_visit_follow_up_brz TIMESTAMP WITHOUT TIME ZONE,
  flg_branded boolean,
