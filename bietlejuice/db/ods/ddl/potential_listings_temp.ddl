drop table public.potential_listings_temp;
create table public.potential_listings_temp (
...
CREATE INDEX temp_pot_list_lead_id_idx ON public.potential_listings_temp USING btree (lead_id);
CREATE INDEX temp_pot_list_region_id_idx ON public.potential_listings_temp USING btree (region_id);
CREATE INDEX temp_pot_list_usuario_que_cadast_id_idx ON public.potential_listings_temp USING btree (house_usuario_que_cadastrou_id);
