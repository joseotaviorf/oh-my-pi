drop table public.listing_flows_with_reprocessed_leads_temp;

create table public.listing_flows_with_reprocessed_leads_temp (
	id bigint NOT NULL,
	lead_id integer,
...
CREATE INDEX temp_reproc_leads_lead_id_idx ON public.listing_flows_with_reprocessed_leads_temp USING btree (lead_id);
CREATE INDEX temp_reproc_leads_imovel_id_idx ON public.listing_flows_with_reprocessed_leads_temp USING btree (imovel_id);
