drop table public.sales_listing_flows_with_reprocessed_leads;

create table public.sales_listing_flows_with_reprocessed_leads (
	id bigint NOT NULL,
	lead_id integer,
	...
	dt_opt_out_sale timestamp,
	lead_context_origin varchar(255),
	listing_rent_status varchar(255)
);

CREATE INDEX reproc_sales_leads_lead_id_idx ON public.sales_listing_flows_with_reprocessed_leads USING btree (lead_id);
CREATE INDEX reproc_sales_leads_imovel_id_idx ON public.sales_listing_flows_with_reprocessed_leads USING btree (imovel_id);
