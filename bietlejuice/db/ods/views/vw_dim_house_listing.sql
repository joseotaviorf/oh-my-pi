...
special_conditions as (
  ...
  -- example:
  -- ---------------------------------------------------------------------------------------------
  -- |     id      |  special_condition_type  |       ts_opted_in      |       ts_opted_out      |
  -- ---------------------------------------------------------------------------------------------
  -- |    33713	   |       Exclusivity	      |   2019-04-24 21:01:08	 |           null          | -> will be removed
  -- |    33713	   |       Exclusivity	      |   2019-04-24 21:01:08	 |    2019-04-24 21:01:10  | -> will be removed
  -- |    33713	   |       Exclusivity	      |   2019-04-24 21:05:17	 |           null          | -> will be removed
  -- |    33713	   |       Exclusivity	      |   2019-04-24 21:05:17	 |    2019-04-24 21:05:35  |
  -- ---------------------------------------------------------------------------------------------
    select
      id,
    ...
    where special_condition_status in ('OptedIn', 'OptedOut')
      and special_condition_status_mod = 1
...
-- ----------------------------------------------------------------------------------
  select
    ...
    max(sc.in_) as dt_last_opted_in,
    max(sc.out_) as dt_last_opted_out
...
left join listing_special_conditions_originals lsc_originals
