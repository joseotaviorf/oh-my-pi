...
_fact as (
	select
        ...
        coalesce(to_char(vdp.dt_first_credit_evaluation_init, 'YYYYMMDD')::integer, -1) as sk_first_credit_evaluation_init,
        coalesce(to_char(vdp.dt_last_credit_evaluation_init, 'YYYYMMDD')::integer, -1) as sk_last_credit_evaluation_init,
        coalesce(to_char(vdp.dt_first_credit_evaluation_negative, 'YYYYMMDD')::integer, -1) as sk_first_credit_evaluation_negative,
        coalesce(to_char(vdp.dt_last_credit_evaluation_negative, 'YYYYMMDD')::integer, -1) as sk_last_credit_evaluation_negative,
        coalesce(to_char(vdp.dt_first_doc_analysis_approved, 'YYYYMMDD')::integer, -1) as sk_first_doc_analysis_approved,
        coalesce(to_char(vdp.dt_last_doc_analysis_approved, 'YYYYMMDD')::integer, -1) as sk_last_doc_analysis_approved,
        coalesce(to_char(vdp.dt_first_doc_analysis_rejected, 'YYYYMMDD')::integer, -1) as sk_first_doc_analysis_rejected,
        coalesce(to_char(vdp.dt_last_doc_analysis_rejected, 'YYYYMMDD')::integer, -1) as sk_last_doc_analysis_rejected,
