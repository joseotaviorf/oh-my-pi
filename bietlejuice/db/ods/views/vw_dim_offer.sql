...
old_pre_proposal as (
    select
      ...
      last_rent_value_tenant as last_rent_value_offered_by_tenant,
      last_rent_value_landlord as last_rent_value_offered_by_owner,
      total_rent_value,
      p.rejection_reason,
      p.animais_condition,
...
new_offer as (
    select distinct
      ...
      expiration_date,
      last_rent_value_offered_by_tenant,
      last_rent_value_offered_by_owner,
