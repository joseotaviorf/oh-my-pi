...
--create or replace view vw_dim_lead as
 select distinct
  ...
  l.reason_detail,
  case
		when l.reason_detail in ('CONTACT_ON_BLOCK_LIST', 'CONTACT_KNOW_OWNER','CONTACT_WASNT_THE_HOUSE_OWNER','CONTACT_DIDNT_EXIST','OWNER_DIDNT_ANSWER_PHONE',
		                        ...
		                        'DUPLICATED_LEAD') then 'Nunca'
		when l.reason_detail in ('ISSUES_WITH_HOUSE_ENTRANCE_CONDITIONS','HOUSE_UNDER_EXCLUSIVITY_CONTRACT','OWNER_WITH_PRIME_PROFILE',
					 ...
					 then 'Curto Prazo'
		when l.reason_detail in ('SEASONAL_RENT','ONLY_PART_OF_THE_HOUSE_WAS_AVAILABLE_FOR_RENTING','ISSUES_WITH_HOUSE_DOCUMENTATION','HOUSE_UNDER_MAJOR_RENOVATION',
		                        'HOUSE_ALREADY_RENTED','OWNER_GAVE_UP_RENTING','OWNER_DISAGREE_CHARGES_PAYMENTS','OWNER_DIDNT_LISTEN_TO_PITCH',
		                        'OWNER_DISAGREE_PAYMENT_TIMING','OWNER_GAVE_UP_SELLING','PROPERTY_IN_OFFPLANT','PROPERTY_IN_JUDICIAL_INVENTORY') then 'Longo Prazo'
