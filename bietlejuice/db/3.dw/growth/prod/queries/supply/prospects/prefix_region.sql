...
all_dates_last_month as (
	...
	left join dim_region dr
		on dpr.regiao_id = dr.id
	where f.sk_prospect_date between to_char(add_months(date_trunc('month', current_date), -1), 'YYYYMMDD')
...
all_dates_last_year as (
  ...
  left join dim_region dr
  	on dpr.regiao_id = dr.id
	where f.sk_prospect_date between to_char(add_months(date_trunc('year', current_date), -12), 'YYYYMMDD')
