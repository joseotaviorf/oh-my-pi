...
all_dates_last_month as (
  ...
  group by date_part('year', to_date(f.sk_lead_date::varchar, 'YYYYMMDD')), date_part('month', to_date(f.sk_lead_date::varchar, 'YYYYMMDD'))
  order by date_part('year', to_date(f.sk_lead_date::varchar, 'YYYYMMDD')), date_part('month', to_date(f.sk_lead_date::varchar, 'YYYYMMDD'))
),
all_dates_last_year as (
  ...
  group by date_part('year', to_date(f.sk_lead_date::varchar, 'YYYYMMDD'))
  order by date_part('year', to_date(f.sk_lead_date::varchar, 'YYYYMMDD'))
),