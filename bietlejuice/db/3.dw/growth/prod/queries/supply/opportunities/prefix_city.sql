with all_dates_prev as (
  ...
  order by coalesce(dr.city_name, ''), date_part('year', to_date(f.sk_opportunity_date::varchar, 'YYYYMMDD')), date_part('month', to_date(f.sk_opportunity_date::varchar, 'YYYYMMDD')), date_part('week', to_date(f.sk_opportunity_date::varchar, 'YYYYMMDD')), date_part('day', to_date(f.sk_opportunity_date::varchar, 'YYYYMMDD'))
),
all_dates as (
  select distinct
    _year,
...
all_dates_last_month as (
	...
	where date_part('year', to_date(f.sk_opportunity_date::varchar, 'YYYYMMDD')) = date_part('year', add_months(current_date, -1))
 	...
 	group by coalesce(dr.city_name, ''), date_part('year', to_date(f.sk_opportunity_date::varchar, 'YYYYMMDD')), date_part('month', to_date(f.sk_opportunity_date::varchar, 'YYYYMMDD'))
  order by coalesce(dr.city_name, ''), date_part('year', to_date(f.sk_opportunity_date::varchar, 'YYYYMMDD')), date_part('month', to_date(f.sk_opportunity_date::varchar, 'YYYYMMDD'))
),
all_dates_last_year as (
  ...
  where date_part('year', to_date(f.sk_opportunity_date::varchar, 'YYYYMMDD')) = date_part('year', add_months(current_date, -12))
	...
	group by coalesce(dr.city_name, ''), date_part('year', to_date(f.sk_opportunity_date::varchar, 'YYYYMMDD'))
	order by coalesce(dr.city_name, ''), date_part('year', to_date(f.sk_opportunity_date::varchar, 'YYYYMMDD'))
),
