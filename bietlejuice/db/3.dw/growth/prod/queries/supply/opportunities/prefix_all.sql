...
all_dates_last_month as (
	...
	from fact_supply f
	where f.sk_opportunity_date between to_char(add_months(date_trunc('month', current_date), -1), 'YYYYMMDD')
...
all_dates_last_year as (
	...
	from fact_supply f
	where f.sk_opportunity_date between to_char(add_months(date_trunc('year', current_date), -12), 'YYYYMMDD')
