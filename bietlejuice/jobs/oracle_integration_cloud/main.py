...
class OICPipeline:
    ...
    def run(self):
        ...
        try:
            ...
            old_files = sftp_handler.list_files(hcm_tablename=args["table_name"])
            for file in old_files:
                sftp_handler.delete_file(file)

            oic_api = OICprocessingAPI(environment=args["environment"])
            oic_api.send_process_request(report_name=args["table_name"].upper())

            new_files = sftp_handler.list_files(hcm_tablename=args["table_name"])
