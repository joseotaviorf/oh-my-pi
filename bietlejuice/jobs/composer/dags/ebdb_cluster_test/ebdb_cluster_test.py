...
CLUSTER_DESCRIPTION = Variable.get(
    "databricks_ebdb_test_cluster", deserialize_json=True
)
...
def build_subdags(stage):
    ...
    file_list = FileService.list_layer_sql_files("ebdb", stage)
    subdags = {}
