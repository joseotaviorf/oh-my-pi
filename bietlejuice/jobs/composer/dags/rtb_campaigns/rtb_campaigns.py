...
CUSTOM_LIBRARIES = [
    {
        "whl": f"{ARTIFACTS_S3_BUCKET}/rtb-api-client-python/"
        f"quintoandar_rtb_api_client-0.1.6-py2.py3-none-any.whl"
    }
]
...
rtb_campaigns_to_datalake_raw_task = QuintoAndarDatabricksSubmitRunOperator(
    task_id="rtb-campaigns-to-datalake-raw",
    dag=dag,
    json={
        "spark_python_task": {
...
create_cluster_task >> rtb_campaigns_to_datalake_raw_task >> list(
    clean_sub_dags.values()
) >> terminate_cluster_task

airflow_helpers.chain(
    rtb_campaigns_to_datalake_raw_task,
