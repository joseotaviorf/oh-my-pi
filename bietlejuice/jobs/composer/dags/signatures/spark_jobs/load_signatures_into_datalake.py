...
SOURCE = "signatures"
JOB_NAME = "load_signatures_into_datalake"
BLOCK_LIST = ["agreement_document_bkp", "change_owner_control", "flyway_schema_history"]
...
if __name__ == "__main__":
    ...
    conn_config_json = dbutils.secrets.get(
        scope="quintoandar", key=DatabaseEnum.SIGNATURES
    )
