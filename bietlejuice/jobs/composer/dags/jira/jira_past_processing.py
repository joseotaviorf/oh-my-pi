...
# DAG params setup
SOURCE = "jira"
DAG_ID = f"bietlejuice.{SOURCE}-past-processing-2020-v1"
local_tz = pendulum.timezone("America/Sao_Paulo")  # use cron expressions in local time
MAIN_START_DATE = datetime(2020, 1, 2, 0, 0, 0, tzinfo=local_tz)
MAIN_END_DATE = datetime(2020, 6, 1, 0, 0, 0, tzinfo=local_tz)
