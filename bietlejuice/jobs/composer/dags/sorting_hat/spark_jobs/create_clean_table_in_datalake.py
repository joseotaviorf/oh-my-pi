...
from bietlejuice.jobs.composer.dags.sorting_hat import (
    SOURCE,
    QUERIES_SORTING_HAT_DATALAKE_PATH,
)
...
if __name__ == "__main__":
    ...
    query = FileService.get_query_from_file_name(
        QUERIES_SORTING_HAT_DATALAKE_PATH + "/clean/" + table_name + ".sql"
    )
    ...
    # create database for Sorting Hat clean tables in Spark Metastore
