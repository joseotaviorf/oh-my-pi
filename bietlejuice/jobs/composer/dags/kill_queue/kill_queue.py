...
kill_queue_to_datalake_raw_task = QuintoAndarDatabricksSubmitRunOperator(
    task_id="kill-queue-to-datalake-raw",
    dag=dag,
    json={
        "spark_python_task": {
...
create_cluster_task >> kill_queue_to_datalake_raw_task
build_clean_subdags(kill_queue_to_datalake_raw_task, terminate_cluster_task)
