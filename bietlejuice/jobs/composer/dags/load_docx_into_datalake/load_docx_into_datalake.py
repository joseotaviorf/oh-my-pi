...
DAG_ID = 'load-docx-into-datalake'
S3_PREFIX = 's3://5a-databricks/github-repos/bi-etl-ejuice'

LOAD_DOCX_INTO_DATALAKE_RAW_FILE_PATH = S3_PREFIX + '/spark_jobs/\
load-docx-into-datalake/load_docx_into_datalake.py'
CREATE_RAW_EXTERNAL_TABLES_FILE_PATH = S3_PREFIX + '/spark_jobs/\
load-docx-into-datalake/create_raw_external_tables.py'

LOGS_OUTPUT_PATH = S3_PREFIX + '/logs/load-docx-into-datalake'
...
docx_to_datalake_raw_task = DatabricksSubmitRunOperator(
