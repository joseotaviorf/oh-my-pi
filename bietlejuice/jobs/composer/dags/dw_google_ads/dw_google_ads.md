...
- `dw_google_ads.fact_google_daily_cost_attributions`
- `dw_google_ads.dim_google_ad`
- `dw_google_ads.dim_google_campaign`
- `dw_google_ads.dim_google_keyword`
- `dw_google_ads.dim_google_video`
...
- `dw_google_ads.fact_google_daily_cost_attributions_old`
- `dw_google_ads.dim_google_ad_old`
- `dw_google_ads.dim_google_campaign_old`
- `dw_google_ads.dim_google_keyword_old`
...
- `google_ads.fact_marketing_daily_costs_old_facebook`
- `google_ads.fact_marketing_daily_costs_old_google`
...
- `dw_google_ads.fact_google_daily_cost_attributions_gut`
- `dw_google_ads.dim_google_ad_gut`
