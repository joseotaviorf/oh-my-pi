...
from bietlejuice.jobs.composer.dags.dw_teravoz_fact_call_queues import (
    DW_SCHEMA,
    QUERIES_DW_TERAVOZ_FACT_CALL_QUEUES_PATH,
)
...
if __name__ == "__main__":
    ...
    query = FileService.get_query_from_file_name(
        QUERIES_DW_TERAVOZ_FACT_CALL_QUEUES_PATH + "/dw/" + table_name + ".sql"
    )
