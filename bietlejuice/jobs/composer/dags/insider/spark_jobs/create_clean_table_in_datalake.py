...
from bietlejuice.jobs.composer.dags.insider import SOURCE, QUERIES_INSIDER_DATALAKE_PATH
...
if __name__ == "__main__":
    ...
    query = FileService().get_query_from_file_name(
        QUERIES_INSIDER_DATALAKE_PATH + "/clean/" + table_name + ".sql"
    )
    ...
    # create database to Insider clean tables in Spark Metastore
