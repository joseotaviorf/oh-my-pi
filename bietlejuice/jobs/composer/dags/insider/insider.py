...
from bietlejuice.jobs.composer.dags.insider import SOURCE
...
insider_to_datalake_raw_task = QuintoAndarDatabricksSubmitRunOperator(
    ...
    json={
        "spark_python_task": {
            "python_file": SPARK_JOBS_PATH + "load_insider_into_datalake.py",
...
airflow_helpers.chain(
    insider_to_datalake_raw_task, sync_metastore_raw_tables_task, terminate_cluster_task
)

build_clean_subdags(
    prev_task=insider_to_datalake_raw_task, next_task=terminate_cluster_task
)
