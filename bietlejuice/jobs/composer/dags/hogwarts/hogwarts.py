...
RAW_SPARK_JOB_PATH = f"{S3_PREFIX}/spark_jobs/{SOURCE}/load_hogwarts_into_datalake.py"
...
create_cluster_task >> hogwarts_to_datalake_raw_task >> list(
    clean_sub_dags.values()
) >> terminate_cluster_task

airflow_helpers.chain(
    hogwarts_to_datalake_raw_task, sync_metastore_tables_task, terminate_cluster_task
)
