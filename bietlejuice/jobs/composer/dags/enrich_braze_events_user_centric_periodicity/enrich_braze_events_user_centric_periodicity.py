...
SOURCE = "braze"
CONTEXT = f"{SOURCE}_events_user_centric_periodicity"
...
enrich_task_groups = datalake_task_group.build_task_group_from_sql_files(
    ...
    source_database_base_name=f"{SOURCE}_user_centric_periodicity",
    target_database_base_name=f"{SOURCE}_user_centric_periodicity",
    is_incremental=True,
