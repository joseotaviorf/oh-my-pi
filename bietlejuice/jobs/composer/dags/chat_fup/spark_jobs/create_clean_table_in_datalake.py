...
from bietlejuice.jobs.composer.dags.chat_fup import (
    SOURCE,
    QUERIES_CHAT_FUP_DATALAKE_PATH,
)
...
if __name__ == "__main__":
    ...
    query = FileService.get_query_from_file_name(
        QUERIES_CHAT_FUP_DATALAKE_PATH + "/clean/" + table_name + ".sql"
    )
    ...
    # create database for Chat Fup clean tables in Spark Metastore
