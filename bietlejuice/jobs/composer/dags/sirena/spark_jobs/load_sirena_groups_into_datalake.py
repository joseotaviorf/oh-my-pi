...
SCHEMA = """
    ...
    displayName STRING COMMENT 'Public name of the group',
    name STRING COMMENT 'Internal name of the group.',
    parent STRING COMMENT 'Parent Group Id',
    ancestors ARRAY<STRING> COMMENT 'Ancestors of the group',
    descendants ARRAY<STRING> COMMENT 'Descendants of the group',
    type ARRAY<STRING> COMMENT 'Type of group (store, leadProvider, group, OEM)',
    timezone STRING COMMENT 'The timezone configured for the group',
    countryCode STRING
"""
