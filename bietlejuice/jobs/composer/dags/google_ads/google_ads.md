...
* raw:
    - `datalake_google_ads_raw.ads_performance_report`
    - `datalake_google_ads_raw.keywords_performance_report`
    - `datalake_google_ads_raw.campaigns_performance_report`
    - `datalake_google_ads_raw.videos_performance_report`
* clean:
