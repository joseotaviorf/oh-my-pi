...
INCREMENTAL_TABLES_MAPPING = {"notificationentities": "lastStatusChangedDate"}
...
if __name__ == "__main__":
    ...
    conn_config = dbutils.secrets.get(scope="quintoandar", key=DatabaseEnum.JAIMINHO)
    ...
    for table_name, date_column in INCREMENTAL_TABLES_MAPPING.items():
