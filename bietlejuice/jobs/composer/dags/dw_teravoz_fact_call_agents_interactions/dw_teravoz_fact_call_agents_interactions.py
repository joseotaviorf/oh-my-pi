...
from bietlejuice.jobs.composer.dags.dw_teravoz_fact_call_agents_interactions import (
    SOURCE,
    DW_SCHEMA,
    QUERIES_DW_TERAVOZ_FACT_CALL_AGENTS_INTERACTIONS_PATH,
)
...
def build_subdags(stage):
    ...
    file_list = FileService.list_files(
        f"{QUERIES_DW_TERAVOZ_FACT_CALL_AGENTS_INTERACTIONS_PATH}/{stage}"
    )
    subdags = {}
