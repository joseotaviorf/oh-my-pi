...
LOAD_BOB_INTO_DATALAKE_RAW_FILE_PATH = (
    S3_PREFIX + f"/spark_jobs/{DAG_NAME}/load_bob_into_datalake.py"
)
...
bob_to_datalake_raw_task = QuintoAndarDatabricksSubmitRunOperator(
    task_id="bob-to-datalake-raw",
    dag=dag,
    json={
        "spark_python_task": {
            "python_file": LOAD_BOB_INTO_DATALAKE_RAW_FILE_PATH,
...
bob_to_datalake_raw_task >> sync_metastore_tables_task >> terminate_cluster_task
