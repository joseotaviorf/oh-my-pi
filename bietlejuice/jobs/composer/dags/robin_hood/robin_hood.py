...
CLUSTER_DESCRIPTION = Variable.get(
    "databricks_bietlejuice_robin_hood", deserialize_json=True
)
...
robin_hood_to_datalake_raw_task = QuintoAndarDatabricksSubmitRunOperator(
    task_id="robin_hood-to-datalake-raw",
    dag=dag,
    json={
        "spark_python_task": {
            "python_file": SPARK_JOBS_PATH + "load_robin_hood_into_datalake.py",
...
create_cluster_task >> robin_hood_to_datalake_raw_task >> terminate_cluster_task
build_clean_subdags(robin_hood_to_datalake_raw_task, terminate_cluster_task)
