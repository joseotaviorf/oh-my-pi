...
from bietlejuice.jobs.composer.dags.robin_hood import (
    SOURCE,
    QUERIES_ROBIN_HOOD_DATALAKE_PATH,
)
...
if __name__ == "__main__":
    ...
    query = FileService().get_query_from_file_name(
        QUERIES_ROBIN_HOOD_DATALAKE_PATH + "/clean/" + table_name + ".sql"
    )
    ...
    # create database to Robin Hood clean tables in Spark Metastore
