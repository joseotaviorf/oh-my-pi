...
class FacebookSubDAG(BaseSubDAG):
    """
    ...
    def build_subdag(
        ...
        :param accounts_name_mapping: dict mapping id_account to account_name
        ...
        load_table = QuintoAndarDatabricksSubmitRunOperator(
            ...
            json={
                "spark_python_task": {
                    "python_file": f"{self.spark_job_paths}load_facebook_insights.py",
                    "parameters": [
                        self.env,
