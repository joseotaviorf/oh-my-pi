...
from bietlejuice.jobs.composer.dags.vans import SOURCE, QUERIES_VANS_DATALAKE_PATH
...
if __name__ == "__main__":
    ...
    query = FileService().get_query_from_file_name(
        QUERIES_VANS_DATALAKE_PATH + "/clean/" + table_name + ".sql"
    )
    ...
    # create database to Vans clean tables in Spark Metastore
