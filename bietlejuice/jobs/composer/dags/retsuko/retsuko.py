...
LOAD_RETSUKO_INTO_DATALAKE_RAW_FILE_PATH = (
    S3_PREFIX + "/spark_jobs/{}/load_retsuko_into_datalake.py".format(DAG_ID)
)
...
retsuko_to_datalake_raw_task = QuintoAndarDatabricksSubmitRunOperator(
    ...
    json={
        "spark_python_task": {
            "python_file": LOAD_RETSUKO_INTO_DATALAKE_RAW_FILE_PATH,
            "parameters": [ENV],
        }
    },
)
