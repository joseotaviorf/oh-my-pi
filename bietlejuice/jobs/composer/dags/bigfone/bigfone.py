...
LOAD_BIGFONE_INTO_DATALAKE_RAW_FILE_PATH = (
    S3_PREFIX + f"/spark_jobs/{SOURCE}/load_bigfone_into_datalake.py"
)
...
bigfone_to_datalake_raw_task = QuintoAndarDatabricksSubmitRunOperator(
    ...
    json={
        "spark_python_task": {
            "python_file": LOAD_BIGFONE_INTO_DATALAKE_RAW_FILE_PATH,
