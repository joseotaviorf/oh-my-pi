...
JOB_NAME = "load_trato_feito_into_datalake"
BLOCK_LIST = ["change_owner_control", "schema_migrations", "pg_buffercache"]
...
if __name__ == "__main__":
    ...
    logger.info(
        f"m=__main__, environment={environment}, datalake_bucket={datalake_bucket}, source={source},"
    ...
    conn_config_json = dbutils.secrets.get(
        scope="quintoandar", key=DatabaseEnum.TRATO_FEITO
    )
