...
PARTITION_COLS = ["event_channel", "year", "month", "day"]

CONTEXT = "braze_events_dispatches"
...
enrich_task_groups = datalake_task_group.build_task_group_from_sql_files(
    ...
    source_database_base_name="braze_dispatches",  # TODO this should be the context
    target_database_base_name="braze_dispatches",  # TODO this should be the context
    is_incremental=True,
