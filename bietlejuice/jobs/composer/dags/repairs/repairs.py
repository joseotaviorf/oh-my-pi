...
clean_partition_columns = config_service.get_config("clean_partition_columns")

RAW_SPARK_JOB_PATH = f"{databricks_bietlejuice_repo_path}/spark_jobs/{CONTEXT}/load_{{extraction_type}}_tables_into_datalake_raw.py"
...
for table in tables:
    ...
    partitions = clean_partition_columns if is_incremental else None
