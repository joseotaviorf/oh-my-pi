...
This DAG get and clean data from our spark metastore, our documentation available in the data-documentation S3 bucket and lineage and tag files created for our other DAGs.
