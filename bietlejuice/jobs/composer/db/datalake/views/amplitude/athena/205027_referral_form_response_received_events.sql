CREATE OR REPLACE VIEW datalake_amplitude_clean_prod."205027_referral_form_response_received_events" AS
    SELECT
        *,
    ...
    FROM
        datalake_amplitude_clean_staging_prod."205027_referral_form_response_received_events";
