CREATE OR REPLACE VIEW datalake_amplitude_clean_prod."183047_price_suggestion_sale_form_submitted_events" AS
    SELECT
        *,
    ...
    FROM
        datalake_amplitude_clean_staging_prod."183047_price_suggestion_sale_form_submitted_events";