DROP VIEW IF EXISTS datalake_amplitude_clean.170698_search_results_page_viewed_events;
CREATE OR REPLACE VIEW datalake_amplitude_clean.170698_search_results_page_viewed_events
AS
  SELECT
    *,
