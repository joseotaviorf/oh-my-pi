DROP VIEW IF EXISTS datalake_amplitude_clean.183047_price_suggestion_form_submitted_events;
CREATE OR REPLACE VIEW datalake_amplitude_clean.183047_price_suggestion_form_submitted_events
AS
    SELECT
        *,
    ...
    FROM
        datalake_amplitude_clean_staging.183047_price_suggestion_form_submitted_events;