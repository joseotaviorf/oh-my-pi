DROP VIEW IF EXISTS datalake_amplitude_clean.170698_contract_docusign_signed_events;
CREATE OR REPLACE VIEW datalake_amplitude_clean.170698_contract_docusign_signed_events
AS
  SELECT
    *,
  ...
  FROM
    datalake_amplitude_clean_staging.170698_contract_docusign_signed_events
;