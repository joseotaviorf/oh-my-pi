DROP VIEW IF EXISTS datalake_amplitude_clean.183049_offer_submitted_events;
CREATE OR REPLACE VIEW datalake_amplitude_clean.183049_offer_submitted_events
AS
    SELECT
        id_user,
