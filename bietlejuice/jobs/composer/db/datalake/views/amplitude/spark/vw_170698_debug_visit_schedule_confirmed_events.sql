DROP VIEW IF EXISTS datalake_amplitude_clean.170698_debug_visit_schedule_confirmed_events;
CREATE OR REPLACE VIEW datalake_amplitude_clean.170698_debug_visit_schedule_confirmed_events
AS
  SELECT
    *,
