DROP VIEW IF EXISTS datalake_amplitude_clean.205027_referral_form_discarded_events;
CREATE OR REPLACE VIEW datalake_amplitude_clean.205027_referral_form_discarded_events
AS
    SELECT
        *,
    ...
    FROM
        datalake_amplitude_clean_staging.205027_referral_form_discarded_events;