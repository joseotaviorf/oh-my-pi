DROP VIEW IF EXISTS datalake_snowplow_raw_prod.open_ticket_finish_success_detailed;
CREATE OR REPLACE VIEW datalake_snowplow_raw_prod.open_ticket_finish_success_detailed AS
WITH event_open_ticket_finish_success AS (
    SELECT 
    ...
    WHERE 
        vendor = 'magiclink'
        AND event = 'open_ticket_finish_success'
...
SELECT 
    ...
    day
FROM 
    event_open_ticket_finish_success
;