DROP VIEW IF EXISTS datalake_snowplow_raw_prod.knowledge_base_load_suggestion_detailed;
CREATE OR REPLACE VIEW datalake_snowplow_raw_prod.knowledge_base_load_suggestion_detailed AS
WITH event_knowledge_base_load_suggestion AS (
    SELECT 
    ...
    WHERE 
        vendor = 'magiclink'
        AND event = 'knowledge_base_load_suggestion'
...
SELECT 
    ...
    day
FROM 
    event_knowledge_base_load_suggestion
;