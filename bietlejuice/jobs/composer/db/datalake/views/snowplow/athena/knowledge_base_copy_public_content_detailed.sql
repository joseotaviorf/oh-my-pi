DROP VIEW IF EXISTS datalake_snowplow_raw_prod.knowledge_base_copy_public_content_detailed;
CREATE OR REPLACE VIEW datalake_snowplow_raw_prod.knowledge_base_copy_public_content_detailed AS
WITH event_knowledge_base_copy_public_content AS (
    SELECT 
    ...
    WHERE 
        vendor = 'magiclink'
        AND event = 'knowledge_base_copy_public_content'
...
SELECT 
    ...
    day
FROM 
    event_knowledge_base_copy_public_content
;