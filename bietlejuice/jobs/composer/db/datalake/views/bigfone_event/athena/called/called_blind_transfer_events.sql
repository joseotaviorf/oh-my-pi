drop view if exists datalake_bigfone_clean_prod.called_blind_transfer_events;
create or replace view datalake_bigfone_clean_prod.called_blind_transfer_events as
select
    id,
    id_call,
