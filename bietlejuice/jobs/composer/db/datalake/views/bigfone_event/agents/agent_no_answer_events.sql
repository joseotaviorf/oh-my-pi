drop view if exists datalake_bigfone_clean_prod.agent_no_answer_events;
create or replace view datalake_bigfone_clean_prod.agent_no_answer_events as
select
    id,
    id_call,
    ...
    cast(json_extract_scalar(metadata, '$.ringtime') as smallint) as seconds_ringing,
    ts_created,
    ts_created_local,
    ts_received,
    ts_received_local,
