drop view if exists datalake_bigfone_clean_prod.agent_logged_in_events;
create or replace view datalake_bigfone_clean_prod.agent_logged_in_events as
select
    id,
