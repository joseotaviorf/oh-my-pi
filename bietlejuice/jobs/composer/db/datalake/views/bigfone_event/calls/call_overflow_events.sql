drop view if exists datalake_bigfone_clean_prod.call_overflow_events;
create or replace view datalake_bigfone_clean_prod.call_overflow_events as
select
    id,
    id_call,
    ...
    cast(json_extract_scalar(metadata, '$.destination') as smallint) as destination_queue,
    ts_created,
    ts_created_local,
    ts_received,
    ts_received_local,
