...
SELECT
	...
	GET_JSON_OBJECT(t.task_attributes,'$.tagsByType.contact_theme_tag') AS contact_theme_tag,
	GET_JSON_OBJECT(t.task_attributes,'$.tagsByType.customer_type_tag') AS customer_type_tag,
	GET_JSON_OBJECT(t.task_attributes,'$.tagsByType.contact_motivation_tag') AS contact_motivation_tag,
	CAST(GET_JSON_OBJECT(t.task_attributes,'$.forwarding') AS BOOLEAN) AS is_forwarded,
	CAST(GET_JSON_OBJECT(t.task_attributes,'$.long_lived') AS BOOLEAN) AS is_long_lived,
	CAST(GET_JSON_OBJECT(t.task_attributes,'$.task_number') AS INT) AS task_number,
