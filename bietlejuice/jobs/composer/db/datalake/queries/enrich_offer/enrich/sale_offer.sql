...
SELECT
  ...
  m.credit_model,
  m.closing_status,
  m.house_dilligence_status,
  m.seller_dilligence_status,
  m.report_dilligence_status,
  m.diligence_appointment_reason,
  m.bank_analysis_status,
  m.payment_status,
  m.credit_status,
  m.notary_office_status,
  m.real_estate_register_office_status,
  m.tags_from_salesflow,
