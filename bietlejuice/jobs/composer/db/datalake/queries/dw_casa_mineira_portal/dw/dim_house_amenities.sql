    ...
    data_house_attributes AS (
        ...
        FROM 
            ...
            FOR (nome_atributo) IN (
                ...
                'Box Blindex_Imóvel' AS has_blindex_box_imovel,
                'Churrasqueira_Edifício' AS has_grill_edifice,
                'Closet_Imóvel' AS has_closet_imovel,
                ...
                'Hidromassagem_Imóvel' AS has_whirlpool_imovel,
                ...
                'Piscina Infantil_Edifício' AS has_kid_pool_edificio,
                ...
                'Quartos_Armário' AS has_bedroom_cabinet_house,
...
SELECT
    ...
    (has_blindex_box_imovel IS NOT DISTINCT FROM 1) AS has_blindex_box_imovel,
    (has_grill_edifice IS NOT DISTINCT FROM 1) AS has_grill_edifice,
    (has_closet_imovel IS NOT DISTINCT FROM 1) AS has_closet_imovel,
    ...
    (has_whirlpool_imovel IS NOT DISTINCT FROM 1) AS has_whirlpool_imovel,
    ...
    (has_kid_pool_edificio IS NOT DISTINCT FROM 1) AS has_kid_pool_edificio,
    ...
    (has_bedroom_cabinet_house IS NOT DISTINCT FROM 1) AS has_bedroom_cabinet_house,
