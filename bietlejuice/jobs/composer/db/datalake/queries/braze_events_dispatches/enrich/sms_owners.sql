...
LEFT JOIN
	datalake_braze.events_owners AS sendtocarrier_owners
		...
		AND eo.id_braze = sendtocarrier_owners.id_braze 
...
LEFT JOIN
	datalake_braze.events_owners AS delivery_owners
		...
		AND eo.id_braze = delivery_owners.id_braze
...
LEFT JOIN
	datalake_braze.events_owners AS rejection_owners
		...
		AND eo.id_braze = rejection_owners.id_braze
...
LEFT JOIN
	datalake_braze.events_owners AS deliveryfailure_owners
		...
		AND eo.id_braze = deliveryfailure_owners.id_braze
