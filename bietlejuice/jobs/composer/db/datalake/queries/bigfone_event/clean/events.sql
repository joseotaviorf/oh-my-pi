...
select 
    ...
    date_format(events.event_timestamp, 'y-MM-dd hh:mm:ss') as ts_created,
    date_format(from_utc_timestamp(events.event_timestamp, 'Brazil/East'), 'y-MM-dd hh:mm:ss') as ts_created_local,
    date_format(events.received_timestamp, 'y-MM-dd hh:mm:ss') as ts_received,
    date_format(from_utc_timestamp(events.received_timestamp, 'Brazil/East'), 'y-MM-dd hh:mm:ss') as ts_received_local,
    events.year as year,
