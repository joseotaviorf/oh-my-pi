...
SELECT
  ...
  CAST(REGEXP_EXTRACT(GET_JSON_OBJECT(updated_message, '$.motivos_de_descarte__dm_.value'), '(\\w+)') AS BIGINT) AS current_drop_reason,
...
SELECT
  ...
  CASE WHEN moa.dt_accepted <= moa.dt_offer_dismissed THEN DATEDIFF(moa.dt_accepted, moa.dt_offer_dismissed) END AS days_offer_accepted_to_offer_dismissed,
  DATEDIFF(moa.dt_accepted, moa.dt_sale_agreement_created) AS days_offer_accepted_to_sale_agreement_created,
  DATEDIFF(moa.dt_accepted, moa.dt_sale_agreement_signed) AS days_offer_accepted_to_sale_agreement_signed,
  DATEDIFF(moa.dt_accepted, moa.dt_sale_agreement_signed) AS days_sale_agreement_created_to_sale_agreement_signed,
  moa.dt_submitted,
  moa.dt_accepted,
  ...
  moa.dt_dilligence_started,
  moa.dt_dilligence_ended,
