...
SELECT
  ...
  CAST(GET_JSON_OBJECT(updated_message, '$.data3.value') AS DATE) AS dt_deal_qualified,
  ...
  --
  CAST(GET_JSON_OBJECT(updated_message, '$.data_envio.value') AS DATE) AS dt_legaut_analysis_started,
  CAST(GET_JSON_OBJECT(updated_message, '$.data218.value') AS DATE) AS dt_legaut_analysis_ended,
  CAST(GET_JSON_OBJECT(updated_message, '$.data210.value') AS DATE) AS dt_legal_risk_started,
  CAST(GET_JSON_OBJECT(updated_message, '$.data217.value') AS DATE) AS dt_legal_risk_ended,
  CAST(GET_JSON_OBJECT(updated_message, '$.data_in_cio_dilig_ncia.value') AS DATE) AS dt_legal_analysis_ended,
  --
