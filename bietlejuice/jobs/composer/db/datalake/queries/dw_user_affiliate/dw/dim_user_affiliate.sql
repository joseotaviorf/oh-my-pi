...
aff_city_group_with_region as (
	select
		...
		aff_city_region.tracking_source,
		aff_city_region.tracking_medium,
		aff_city_region.tracking_campaign,
		aff_city_region.tracking_content,
		aff_city_region.tracking_term,
