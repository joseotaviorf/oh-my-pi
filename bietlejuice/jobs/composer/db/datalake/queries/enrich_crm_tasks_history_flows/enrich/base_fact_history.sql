WITH actions AS (
  SELECT
    trh.id_task,
    COALESCE(CAST(CAST(trh.id_receiver AS DECIMAL) AS BIGINT), -1) AS id_receiver,
    COALESCE(CAST(CAST(trh.id_origin AS DECIMAL) AS BIGINT), -1) AS id_origin,
    COALESCE(CAST(CAST(trh.id_assignee AS DECIMAL) AS BIGINT), -1) AS id_assignee,
    COALESCE(CAST(CAST(trh.id_user_action AS DECIMAL) AS BIGINT), -1) AS id_user_action,
