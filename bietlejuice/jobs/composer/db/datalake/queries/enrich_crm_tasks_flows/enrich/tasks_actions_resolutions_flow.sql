...
SELECT DISTINCT
  ...
  DATE_TRUNC('SECOND', ct.ts_start) AS ts_started,
  DATE_TRUNC('SECOND', COALESCE(trm.ts_action, ct.ts_completed)) AS ts_completed,
  DATE_TRUNC('SECOND', ct.ts_silenced_until) AS ts_silenced_until,
