SELECT
  ...
  SUM(uetw.total_inapp_message_views) AS total_in_app_message_views_this_week,
  SUM(uelw.total_inapp_message_views) AS total_in_app_message_views_last_week,
  SUM(ue2w.total_inapp_message_views) AS total_in_app_message_views_2w_ago,
  SUM(ue3w.total_inapp_message_views) AS total_in_app_message_views_3w_ago,
  SUM(ueat.total_inapp_message_views) AS total_in_app_message_views_all_time,
  SUM(uetw.total_inapp_message_clicks) AS total_in_app_message_clicks_this_week,
  SUM(uelw.total_inapp_message_clicks) AS total_in_app_message_clicks_last_week,
  SUM(ue2w.total_inapp_message_clicks) AS total_in_app_message_clicks_2w_ago,
  SUM(ue3w.total_inapp_message_clicks) AS total_in_app_message_clicks_3w_ago,
  SUM(ueat.total_inapp_message_clicks) AS total_in_app_message_clicks_all_time,
