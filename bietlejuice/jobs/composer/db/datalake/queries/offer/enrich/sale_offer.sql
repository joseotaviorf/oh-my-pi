...
SELECT
  ...
  DATEDIFF(so.ts_created, m.dt_accepted) AS days_offer_submitted_to_offer_accepted,
  DATEDIFF(so.ts_created, m.dt_offer_dismissed) AS days_offer_submitted_to_offer_dismissed,
  DATEDIFF(so.ts_created, m.dt_sale_agreement_created) AS days_offer_submitted_to_sale_agreement_created,
  DATEDIFF(so.ts_created, m.dt_sale_agreement_signed) AS days_offer_submitted_to_sale_agreement_signed,
