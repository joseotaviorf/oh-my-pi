...
SELECT
  ...
  GET_JSON_OBJECT(moa.updated_message, '$.status07.value') AS payment_model,
  ...
  GET_JSON_OBJECT(moa.updated_message, '$.status135.value') AS early_keys_status,
