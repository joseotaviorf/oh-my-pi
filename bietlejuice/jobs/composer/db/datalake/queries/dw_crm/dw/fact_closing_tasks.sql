...
SELECT DISTINCT
  ...
  CAST(pc.minutes_task_created_to_started AS FLOAT) AS minutes_task_created_to_started,
  CAST(pc.task_user_resolve_hours AS FLOAT) AS task_user_action_resolve_hours,
  pc.action_user_name,
  pc.action_type,
  pc.action_reason,
  pc.task_status,
