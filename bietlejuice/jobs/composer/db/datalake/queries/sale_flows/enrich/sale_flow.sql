...
, sale_flows AS (
  SELECT
    ...
    COALESCE(b.id_buyer, o.id_buyer, tta.id_buyer) AS id_buyer,
...
SELECT
 ...
 CASE
  ...
  DATEDIFF(hi.ts_first_listing, sf.ts_first_event) AS days_first_publication_to_first_event,
  DATEDIFF(hi.ts_first_listing, b.ts_first_booking_created) AS days_first_publication_to_first_booking_created,
  DATEDIFF(hi.ts_first_listing, b.ts_first_visit_completed) AS days_first_publication_to_first_visit_completed,
  DATEDIFF(hi.ts_first_listing, o.ts_first_offer_submitted) AS days_first_publication_to_first_offer_submitted,
  DATEDIFF(hi.ts_first_listing, o.dt_first_offer_accepted) AS days_first_publication_to_first_offer_accepted,
  DATEDIFF(hi.ts_first_listing, o.dt_sale_agreement_signed) AS days_first_publication_to_sale_agreement_signed,
  DATEDIFF(hi.ts_first_listing, o.dt_house_registry_ended) AS days_first_publication_to_house_registry_ended,
  DATEDIFF(sf.ts_first_event, b.ts_first_visit_completed) AS days_first_event_to_first_visit_completed,
  DATEDIFF(sf.ts_first_event, o.ts_first_offer_submitted) AS days_first_event_to_first_offer_submitted,
  DATEDIFF(sf.ts_first_event, o.dt_first_offer_accepted) AS days_first_event_to_first_offer_accepted,
  DATEDIFF(sf.ts_first_event, o.dt_sale_agreement_signed) AS days_first_event_to_sale_agreement_signed,
  DATEDIFF(sf.ts_first_event, o.dt_house_registry_ended) AS days_first_event_to_house_registry_ended,
  DATEDIFF(b.ts_first_booking_created, b.ts_first_visit_completed) AS days_first_booking_created_to_first_visit_completed,
  DATEDIFF(b.ts_first_booking_created, o.ts_first_offer_submitted) AS days_first_booking_created_to_first_offer_submitted,
  DATEDIFF(b.ts_first_booking_created, o.dt_first_offer_accepted) AS days_first_booking_created_to_first_offer_accepted,
  DATEDIFF(b.ts_first_booking_created, o.dt_sale_agreement_signed) AS days_first_booking_created_to_sale_agreement_signed,
  DATEDIFF(b.ts_first_booking_created, o.dt_house_registry_ended) AS days_first_booking_created_to_house_registry_ended,
  DATEDIFF(b.ts_first_visit_completed, o.ts_first_offer_submitted) AS days_first_visit_completed_to_first_offer_submitted,
  DATEDIFF(b.ts_first_visit_completed, o.dt_first_offer_accepted) AS days_first_visit_completed_to_first_offer_accepted,
  DATEDIFF(b.ts_first_visit_completed, o.dt_sale_agreement_signed) AS days_first_visit_completed_to_sale_agreement_signed,
  DATEDIFF(b.ts_first_visit_completed, o.dt_house_registry_ended) AS days_first_visit_completed_to_house_registry_ended,
  DATEDIFF(o.ts_first_offer_submitted, o.dt_first_offer_accepted) AS days_first_offer_submitted_to_first_offer_accepted,
  DATEDIFF(o.ts_first_offer_submitted, o.dt_sale_agreement_signed) AS days_first_offer_submitted_to_sale_agreement_signed,
  DATEDIFF(o.dt_first_offer_accepted, o.dt_sale_agreement_signed) AS days_first_offer_accepted_to_sale_agreement_signed,
  DATEDIFF(o.ts_first_offer_submitted, o.dt_house_registry_ended) AS days_first_offer_submitted_to_house_registry_ended,
  hi.ts_first_listing,
  sf.ts_first_event,
