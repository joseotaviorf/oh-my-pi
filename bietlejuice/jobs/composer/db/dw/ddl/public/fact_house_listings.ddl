drop table if exists public.fact_house_listings;
create table if not exists public.fact_house_listings
(
...
ALTER TABLE public.fact_house_listings OWNER TO databricks;