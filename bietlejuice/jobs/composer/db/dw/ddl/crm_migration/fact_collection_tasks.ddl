DROP TABLE IF EXISTS crm_migration.fact_collection_tasks;
CREATE TABLE crm_migration.fact_collection_tasks (
    sk_task VARCHAR,
...
ALTER TABLE crm_migration.fact_collection_tasks OWNER TO airflow;
