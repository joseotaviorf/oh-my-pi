DROP TABLE IF EXISTS crm_migration.dim_photo_job_task;
CREATE TABLE crm_migration.dim_photo_job_task (
...
ALTER TABLE crm_migration.dim_photo_job_task OWNER TO airflow;
