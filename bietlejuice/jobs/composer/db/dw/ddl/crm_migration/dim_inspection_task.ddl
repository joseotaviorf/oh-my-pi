DROP TABLE IF EXISTS crm_migration.dim_inspection_task;
CREATE TABLE crm_migration.dim_inspection_task (
...
ALTER TABLE crm_migration.dim_inspection_task OWNER TO airflow;
