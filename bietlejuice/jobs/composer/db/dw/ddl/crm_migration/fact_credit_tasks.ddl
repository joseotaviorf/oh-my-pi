DROP TABLE IF EXISTS crm_migration.fact_credit_tasks;
CREATE TABLE crm_migration.fact_credit_tasks (
    sk_task VARCHAR,
    sk_receiver BIGINT,
    sk_origin BIGINT,
    sk_assignee BIGINT,
    ...
    task_user_resolve_hours DECIMAL(11,1),
    ts_action TIMESTAMP,
...
ALTER TABLE crm_migration.fact_credit_tasks OWNER TO airflow;
