DROP TABLE IF EXISTS crm_migration.dim_collection_task;
CREATE TABLE crm_migration.dim_collection_task (
...
ALTER TABLE crm_migration.dim_collection_task OWNER TO airflow;
