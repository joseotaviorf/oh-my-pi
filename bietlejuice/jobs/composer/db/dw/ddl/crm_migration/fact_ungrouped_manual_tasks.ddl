DROP TABLE IF EXISTS crm_migration.fact_ungrouped_manual_tasks;
CREATE TABLE crm_migration.fact_ungrouped_manual_tasks (
    sk_task VARCHAR,
    sk_receiver BIGINT,
...
ALTER TABLE crm_migration.fact_ungrouped_manual_tasks OWNER TO airflow;
