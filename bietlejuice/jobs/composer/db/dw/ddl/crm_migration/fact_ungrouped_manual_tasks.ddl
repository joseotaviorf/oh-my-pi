DROP TABLE IF EXISTS crm.fact_ungrouped_manual_tasks;
CREATE TABLE crm.fact_ungrouped_manual_tasks (
    sk_task VARCHAR,
    sk_receiver BIGINT,
...
ALTER TABLE crm.fact_ungrouped_manual_tasks OWNER TO airflow;
