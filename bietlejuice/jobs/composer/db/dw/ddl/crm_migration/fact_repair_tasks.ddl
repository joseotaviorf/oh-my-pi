DROP TABLE IF EXISTS crm_migration.fact_repair_tasks;
CREATE TABLE crm_migration.fact_repair_tasks (
    sk_task VARCHAR,
...
ALTER TABLE crm_migration.fact_repair_tasks OWNER TO airflow;
