DROP TABLE IF EXISTS crm_migration.fact_onboarding_tenant_tasks;
CREATE TABLE crm_migration.fact_onboarding_tenant_tasks (
    sk_task VARCHAR,
    sk_receiver BIGINT,
...
ALTER TABLE crm_migration.fact_onboarding_tenant_tasks OWNER TO airflow;
