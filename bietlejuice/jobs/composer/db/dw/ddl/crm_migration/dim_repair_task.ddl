DROP TABLE IF EXISTS crm_migration.dim_repair_task;
CREATE TABLE crm_migration.dim_repair_task (
...
ALTER TABLE crm_migration.dim_repair_task OWNER TO airflow;
