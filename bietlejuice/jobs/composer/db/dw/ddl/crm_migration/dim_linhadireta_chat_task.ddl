DROP TABLE IF EXISTS crm_migration.dim_linhadireta_chat_task;
CREATE TABLE crm_migration.dim_linhadireta_chat_task (
...
ALTER TABLE crm_migration.dim_linhadireta_chat_task OWNER TO airflow;
