DROP TABLE IF EXISTS crm_migration.fact_visit_tasks;
CREATE TABLE crm_migration.fact_visit_tasks (
    sk_task VARCHAR,
    sk_booking BIGINT,
...
ALTER TABLE crm_migration.fact_visit_tasks OWNER TO airflow;
