DROP TABLE IF EXISTS crm_migration.dim_credit_task;
CREATE TABLE crm_migration.dim_credit_task (
...
ALTER TABLE crm_migration.dim_credit_task OWNER TO airflow;
