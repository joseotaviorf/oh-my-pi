DROP TABLE IF EXISTS crm_migration.dim_onboarding_tenant_task;
CREATE TABLE crm_migration.dim_onboarding_tenant_task (
...
ALTER TABLE crm_migration.dim_onboarding_tenant_task OWNER TO airflow;
