drop table if exists janus.fact_inspection_bookings;
create table if not exists janus.fact_inspection_bookings (
...
ALTER TABLE janus.fact_inspection_bookings OWNER TO airflow;