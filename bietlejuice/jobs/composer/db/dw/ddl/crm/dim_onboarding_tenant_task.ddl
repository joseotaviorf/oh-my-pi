DROP TABLE IF EXISTS crm.dim_onboarding_tenant_task;
CREATE TABLE crm.dim_onboarding_tenant_task (
...
ALTER TABLE crm.dim_onboarding_tenant_task OWNER TO airflow;
