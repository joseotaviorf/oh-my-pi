DROP TABLE IF EXISTS crm.fact_closing_tasks;
CREATE TABLE crm.fact_closing_tasks (
    sk_task VARCHAR,
    sk_receiver BIGINT,
    ...
    minutes_task_created_to_started DECIMAL(10,1),
...
ALTER TABLE crm.fact_closing_tasks OWNER TO airflow;
