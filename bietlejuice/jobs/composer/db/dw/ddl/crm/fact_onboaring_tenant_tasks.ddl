DROP TABLE IF EXISTS crm.fact_onboarding_tenant_tasks;
CREATE TABLE crm.fact_onboarding_tenant_tasks (
    sk_task VARCHAR,
    sk_receiver BIGINT,
...
ALTER TABLE crm.fact_onboarding_tenant_tasks OWNER TO airflow;
