...
CREATE TABLE IF NOT EXISTS customer_support.fact_demand_metrics (
    ...
    days_spent_on_solved_tickets_within_sla DOUBLE PRECISION,
    days_spent_on_solved_tickets_with_exceed_sla DOUBLE PRECISION,
    total_days_spent DOUBLE PRECISION,
