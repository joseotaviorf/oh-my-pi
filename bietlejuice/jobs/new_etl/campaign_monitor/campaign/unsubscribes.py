...
logger = QuintoAndarLogger('CampaignUnsubscribes')


class CampaignUnsubscribes(CampaignMonitorCampaign):
    @logger(exclude='cm_auth')
    def __init__(self, s3_bucket, cm_auth, _type, execution_date):
        super(CampaignUnsubscribes, self).__init__(s3_bucket, cm_auth, _type, execution_date)
