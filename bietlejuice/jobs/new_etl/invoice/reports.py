...
class Report(Invoice):
    ...
    def transform_data(self):
        ...
        c_cols = OrderedDict([
            ...
            ('_to', str),
            ('description', str),
            ('amount', [float, re.compile(Invoice.REGEX['float']), Invoice.GROUP['float']]),
            ('item', str),
            ('ref_item_ym', str),
            ('due_date', [str, re.compile(Invoice.REGEX['date']), Invoice.GROUP['date']]),
            ('tenant_due_date', [str, re.compile(Invoice.REGEX['date']), Invoice.GROUP['date']]),
            ('tenant_paid_date', [str, re.compile(Invoice.REGEX['date']), Invoice.GROUP['date']]),
            ('tenant_status', [str, re.compile(Invoice.REGEX['date']), Invoice.GROUP['date']]),
            ('landlord_due_date', [str, re.compile(Invoice.REGEX['date']), Invoice.GROUP['date']]),
            ('landlord_paid_date', [str, re.compile(Invoice.REGEX['date']), Invoice.GROUP['date']]),
            ('landlord_status', str),
            ('delayed_days', int)
        ])
