...
class ZendeskTicketMetrics(Zendesk):
    ...
    def move_to_clean(self, class_, bucket_type):
        r_cols = OrderedDict([
            ...
            ('ts_minutes_first_calendar_resolution', str),
            ('ts_minutes_first_business_resolution', str),
            ('ts_requester_updated', str),
            ('ts_solved', str),
            ('assignee_stations', str),
            ('ts_latest_comment_added', str),
            ('reopens', str),
            ('ts_minutes_full_calendar_resolution', str),
            ('ts_minutes_full_business_resolution', str),
            ('id_ticket', str),
            ('replies', str),
            ('ts_minutes_calendar_requester_wait', str),
            ('ts_minutes_business_requester_wait', str),
            ('ts_minutes_calendar_agent_wait', str),
            ('ts_minutes_business_agent_wait', str),
            ('ts_minutes_calendar_on_hold', str),
            ('ts_minutes_business_on_hold', str),
            ('group_stations', str),
