...
def create_datamart_from_dw(table_name, **kwargs):
    query = BaseETL.get_query_from_file_name('{}/{}/unit_economics_map/{}.sql'.format(DW_QUERIES_DIR, DATAMARTS_SCHEMA, table_name))
...
def config_task(dag, queries_dir, python_callable, db, table_name, file_name):
    ...
    file_path = '{}/{}/unit_economics_map/{}'.format(queries_dir, DATAMARTS_SCHEMA, file_name)
