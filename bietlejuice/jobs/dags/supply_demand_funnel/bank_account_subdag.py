...
class BankAccountSubDag(DimSubDag):
    ...
    def __build_data_tasks(self, dag):
        ods_bank_account_task = BaseDAG.build_quintoandar_python_operator(
        ...
        dim_bank_account_staging_task = BaseDAG.build_quintoandar_python_operator(
            dag=dag,
        ...
        dim_bank_account_dw_task = BaseDAG.build_quintoandar_python_operator(
            dag=dag,
