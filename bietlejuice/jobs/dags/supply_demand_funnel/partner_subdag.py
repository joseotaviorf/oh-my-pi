...
logger = QuintoAndarLogger('PartnerSubDag')


class PartnerSubDag(DimSubDag):

    def __init__(self, bucket, sub_dag_name, dag_name, schedule_interval, start_date):
        super(PartnerSubDag, self).__init__(
            bucket=bucket,
            ...
            table_name='Partner',
            ods_stg_table_name='partner'
        )

    @logger
    def build_partner_with_tests(self):
