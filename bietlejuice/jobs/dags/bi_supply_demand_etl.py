...
ods_fact_house_listing_status_history_task = BaseDAG.build_python_operator(
    dag=main_dag,
...
ods_fact_house_listing_status_history_task >> dw_fact_house_listing_status_history_task
