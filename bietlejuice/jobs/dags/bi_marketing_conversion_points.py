...
MAIN_DAG_NAME = 'bi-marketing-conversion-points'
...
# flow
airflow.utils.helpers.chain(taxonomy_supply_active_users_sub_dag, taxonomy_supply_active_user_sessions_sub_dag,
