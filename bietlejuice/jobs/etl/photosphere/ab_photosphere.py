...
metrics = {'usability': {'query': """select
                     ...
                     group by 1,2,3,4,5,6""",
                         ...
                         'schema': OrderedDict([('eventdate',
                                                ...
                                                ('opened',
                                                 int)])},
           'funnel_conversion': {'query': """select
                ...
                group by coalesce(user_id, amplitude_id), imovel_id having avg(if(ab_photosphere='A',10,20)) in (10,20)""",
                                 ...
                                 'schema': OrderedDict([('listing_viewed_dt',
                                                         str),
                                                        ('photosphere_open_dt',
                                                         str),
                                                        ('ab_photosphere',
