...
class CRMTasks(object):
    ...
    def extract_and_load_data(self, fields_projection=None, batch_size=10000):
        ...
        ).batch_size(batch_size)  # reduces the number of trips to the server
    ...
    def _save_to_s3(self, json_list, total_count):
        ...
        logger.info('m=_save_to_s3, file_suffix={}, msg=sending to s3'.format(file_suffix))
        BaseETL.obj_to_s3(
            obj_io=gz_body,
    ...
    @logger
    def move_tasks_resolution_to_clean(self, sql_file_name='create_tasks_resolution_table.sql'):
        _cols = OrderedDict([
            ('score_factor', str),
            ('id_rent_flow', str),
            ('actions', str),
    ...
    def _move_to_clean(self, bucket_folder_suffix, sql_file_name, r_cols, c_cols, queries_folder_suffix=None):
    ...
    @logger
    def _move_fact_to_staging(self,
                              table_name,
                              queues=None,
