...
logger = QuintoAndarLogger('FacebookCampaigns')
...
class FacebookCampaigns(MarketingCampaigns):
    ...
    def extract_marketing_campaigns(self, dt_start):
        ...
        while dt_end <= date.today():
            logger.info('m=extract_marketing_campaigns, dt_start={}, dt_end={}'.format(dt_start, dt_end))
            params = {
            ...
            logger.info('m=extract_marketing_campaigns, account={}'.format('retargeting'))
            ...
            for c in ret_campaigns:
                if dt_start < date(2016, 3, 1):  # regra para pegar ads na conta de social somente ate dez/2016
                    try:
                        ...
                        logger.info('m=extract_marketing_campaigns, exception={}'.format(traceback.format_exc()))
                        pass
                insights.append(c)

            logger.info('m=extract_marketing_campaigns, account={}'.format('acquisition'))
            ...
            logger.info('m=extract_marketing_campaigns, account={}'.format('social'))
            ...
            logger.info('m=extract_marketing_campaigns, account={}'.format('supply'))
