...
class AmplitudeETL(object):
    ...
    def get_all_columns(self):
        ...
        add_partition_raw_query = './bietlejuice/db/2.datalake/queries/amplitude/add_partition_raw.sql'
        self.athena_client.execute_file_query_and_wait_for_results(add_partition_raw_query, today, bucket_datalake)

        raw_query = './bietlejuice/db/2.datalake/queries/amplitude/init_events_raw.sql'
        ...
        drop_partition_raw_query = './bietlejuice/db/2.datalake/queries/amplitude/drop_partition_raw.sql'
    ...
    def insert_new_columns(self, df, df_props, df_json, properties, prefix):
        ...
        for index, row in df.iterrows():
            ...
            for up in up_diff:
                ...
                add_column_clean_query = './bietlejuice/db/2.datalake/queries/amplitude/add_column_clean.sql'
    ...
    def create_parquets(self, df):
        ...
        for df_et in ets:
            ...
            add_partition_clean_query = './bietlejuice/db/2.datalake/queries/amplitude/add_partition_clean.sql'
