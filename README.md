...
- [Getting Started](#getting-started)
  - [Local Setup python 3 - Docker](#local-setup-docker3)
  ...
  - [Local Setup python 2 - Docker](#local-setup-docker2)
    - [Clone the project](#1-clone-the-project)
    - [Change variables value](#2-change-variables-value)
    - [Setup docker environment for the project](#3-setup-docker-environment-for-the-project)
    - [Import application variables](#4-import-application-variables)
    - [Restart Airflow](#5-restart-airflow)
    - [Kill Airflow](#6-kill-airflow)
  - [Local Setup python 2 - virtualenv](#local-setup)
    - [Clone the project](#1-clone-the-project)
...
In files Dockerfile.airflow and docker-compose.yml, we need to change three variables:
...
USER = name of your user on your laptop, so you can get it with the command: `pwd`

Example: `/home/whoami/xpto`, in this case USER is whoami

---------------------

GITHUB_TOKEN = token generated by github

You can get it in the next link: https://github.com/settings/tokens

---------------------

BIETLEJUICE_FOLDER = folder localized your bi-etl-ejuice repo
...
Get after {HOME} value

---------------------

DATABRICKS_TOKEN = token generated by databricks

For more detail in how to get it: https://docs.databricks.com/dev-tools/api/latest/authentication.html
