...
- <USER>: should be the name of your user on your laptop, so you can get it with the command: `whoami`
- <GITHUB_TOKEN>: token generated by Github. You can get it [here](https://github.com/settings/tokens).
- <BIETLEJUICE_FOLDER>: the parent dir of $BIETLEJUICE_HOME.

    Example: /Users/amy/projects/bi-etl-ejuice
    BIETLEJUICE_FOLDER=projects/bi-etl-ejuice
...
In files airflow-py2.Dockerfile and docker-compose.py2.yml, we need to change three variables:    
