drop table if exists datalake_raw.sortinghat_proposal;
create external table datalake_raw.sortinghat_proposal (
  id string,
  imovel_id string,
...
location 's3://5a-datalake/raw/sorting_hat/Proposal/'
tblproperties (
