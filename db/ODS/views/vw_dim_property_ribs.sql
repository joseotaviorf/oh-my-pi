drop view if exists unit_economics.vw_dim_property_ribs;
create or replace view unit_economics.vw_dim_property_ribs
as
...
with de_published_dates as ( 
    ...
    from unit_economics.vw_property_listing_ribs vpl
...
(
	...
	JOIN 
		unit_economics.vw_property_listing_ribs pl
		ON pl.id = im.id
