drop table if exists unit_economics.net_revenue_revenues_brokerage_fee_plus_mgmt_aux;

CREATE TABLE unit_economics.net_revenue_revenues_brokerage_fee_plus_mgmt_aux (
