...
BEGIN
  select
    ...
    u.facebookId, 
    u.linkedInId, 
    f.curso as formacaoCurso,
    f.escola as formacaoEscola,
    f.tipoFormacao as formacaoTipo,
    f.dataInicio as formacaoDataInicio,
    f.dataFim as formacaoDataFim,
    u.novoEmail, 
    u.salario, 
    u.sexo, 
    u.telefonePrincipal, 
    ...
    u.bloqueado, 
    u.rg, 
    u.tempoRespostaMedioSegundos, 
    u.estadoCivil, 
    u.nacionalidade, 
    u.profissao, 
    u.salesforceContatoId, 
