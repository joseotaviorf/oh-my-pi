...
select
	...
	TIMESTAMPDIFF(MINUTE, base.dt_lead, base.dt_prospect) as lead_to_prospect_diff_minutes,
  TIMESTAMPDIFF(MINUTE, base.dt_prospect, base.dt_qualified) as prospect_to_qualified_diff_minutes,
  TIMESTAMPDIFF(MINUTE, base.dt_qualified, coalesce(jf.dataCriacao, jf.dataAgendamento, jf.dataAceitoFotografo, jf.dataUploadFotos)) as qualified_to_opportunity_diff_minutes,
  TIMESTAMPDIFF(MINUTE, coalesce(jf.dataCriacao, jf.dataAgendamento, jf.dataAceitoFotografo, jf.dataUploadFotos),i.firstPublication) as opportunity_to_listing_diff_minutes,
  TIMESTAMPDIFF(MINUTE, base.dt_lead, i.firstPublication) as lead_to_listing_diff_minutes
from
(
	select
		i.id as imovel_id,
