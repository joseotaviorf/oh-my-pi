with all_dates as (
  ...
  group by coalesce(dr.long_region_name, ''), date_part('year', f.dt_qualified), date_part('month', f.dt_qualified), date_part('week', f.dt_qualified), date_part('day', f.dt_qualified)
