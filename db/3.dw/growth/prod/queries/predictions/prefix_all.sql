...
all_dates_last_month as (
  ...
  order by date_part('year', cast(cast("date" as timestamp) as date)), date_part('month', cast(cast("date" as timestamp) as date))
),
all_dates_last_year as (
  ...
  order by date_part('year', cast(cast("date" as timestamp) as date))
),
