with all_dates as (
  ...
  order by coalesce(dr.long_region_name, ''), date_part('year', dp.dt_tenant_first_document_sent), date_part('month', dp.dt_tenant_first_document_sent), date_part('week', dp.dt_tenant_first_document_sent), date_part('day', dp.dt_tenant_first_document_sent)
),
...
all_dates_last_month as (
	...
	where date_part('year', dp.dt_tenant_first_document_sent) = date_part('year', add_months(current_date, -1))
 	...
 	group by coalesce(dr.long_region_name, ''), date_part('year', dp.dt_tenant_first_document_sent), date_part('month', dp.dt_tenant_first_document_sent)
  order by coalesce(dr.long_region_name, ''), date_part('year', dp.dt_tenant_first_document_sent), date_part('month', dp.dt_tenant_first_document_sent)
),
all_dates_last_year as (
  ...
  where date_part('year', dp.dt_tenant_first_document_sent) = date_part('year', add_months(current_date, -12))
	...
	group by coalesce(dr.long_region_name, ''), date_part('year', dp.dt_tenant_first_document_sent)
	order by coalesce(dr.long_region_name, ''), date_part('year', dp.dt_tenant_first_document_sent)
),
