...
all_dates_last_month as (
    ...
    and date_part('month', dd."date") = date_part('month', add_months(current_date, -1))
 	...
 	group by coalesce(dr.city_name, ''), date_part('year', dd."date"), date_part('month', dd."date")
  order by coalesce(dr.city_name, ''), date_part('year', dd."date"), date_part('month', dd."date")
),
all_dates_last_year as (
  ...
  left join dim_region dr
	...
	group by coalesce(dr.city_name, ''), date_part('year', dd."date")
	order by coalesce(dr.city_name, ''), date_part('year', dd."date")
),
