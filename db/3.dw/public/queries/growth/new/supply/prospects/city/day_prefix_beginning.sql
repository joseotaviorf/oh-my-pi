with all_dates as (
  ...
  group by coalesce(dr.city_name, ''), date_part('year', f.dt_lead_and_prospect), date_part('month', f.dt_lead_and_prospect), date_part('week', f.dt_lead_and_prospect), date_part('day', f.dt_lead_and_prospect)
  order by coalesce(dr.city_name, ''), date_part('year', f.dt_lead_and_prospect), date_part('month', f.dt_lead_and_prospect), date_part('week', f.dt_lead_and_prospect), date_part('day', f.dt_lead_and_prospect)
),
