drop table if exists growth.tenant_prospects_city_month;
create table growth.tenant_prospects_city_month as
...
all_dates as (
	...
	from growth.tenant_prospects_all_day d
	join growth.tenant_prospects_all_week w
  	on d._year = w._year
