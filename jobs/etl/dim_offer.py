...
if len(args) > 1:
    if args[1] == 'ODS':
        ...
        a_df = athena_client.execute_query_and_return_dataframe("select * from datalake_raw.planner_agents_schedule")
        ...
        BaseETL.move_table_to_dw(
            ...
            append=False,
            bucket_name='{}/clean/ods/{}'.format(bucket_datalake, old_process_name),
