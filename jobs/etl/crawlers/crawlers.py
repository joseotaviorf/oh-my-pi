                              ...
                              right join dim_external_property dep
                                on cr.id = dep.id and cr.website = dep.source and cr.business = dep.business
                                   and (
                                     ...
                                     or (coalesce(left(cr.iptu, 14)::numeric(16,2), 0) != coalesce(left(dep.iptu, 14)::numeric(16,2), 0))
        ...
        insert_table = BaseETL.from_db_query(
            ...
            query="""with entries_not_changed as  (
                        ...
                        on cr.id = dep.id 
                          ...
                          and (coalesce(left(cr.iptu, 14)::numeric(16,2), 0) = coalesce(left(dep.iptu, 14)::numeric(16,2), 0))
