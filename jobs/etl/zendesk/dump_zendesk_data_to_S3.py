...
class ZendeskDataToS3(object):
    def __init__(self, args):
        ...
        print ('m=init, datalake_bucket_type={}, object_type={}, start_time={}, human_readable_start_time={},'
               ' s3_bucket={}'.format(self.datalake_bucket_type, self.object_type,
    ...
    def save_data_to_s3(self, data, count):
        ...
        self.s3.put_object(Bucket=self.s3_bucket, Key='{0}/zendesk/{1}/{2}'.format(self.datalake_bucket_type,
    ...
    def load_data_from_zendesk_to_clean(self):
        ...
        BaseETL.to_s3(
            ...
            data_table=table,
            bucket_name='{0}/{1}/zendesk/{2}'.format(self.s3_bucket, self.datalake_bucket_type, self.object_type)
        )
