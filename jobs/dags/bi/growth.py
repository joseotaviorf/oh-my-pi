...
leads.set_downstream([new_listings])
new_listings.set_downstream([opportunities])
opportunities.set_downstream([prospects])
prospects.set_downstream([qualifieds])
qualifieds.set_downstream([approved_by_insurer])

approved_by_insurer.set_downstream([documentation_sent])
documentation_sent.set_downstream([offerers])
offerers.set_downstream([offerers_approved])
offerers_approved.set_downstream([offerers_sent_doc])
offerers_sent_doc.set_downstream([offers_approved])

offers_approved.set_downstream([offers_submitted])
offers_submitted.set_downstream([tenant_prospects])
tenant_prospects.set_downstream([tenants])
tenants.set_downstream([visitors])
visitors.set_downstream([visits_booked])

visits_booked.set_downstream([visits_completed])
visits_completed.set_downstream([ongoing_contracts])
