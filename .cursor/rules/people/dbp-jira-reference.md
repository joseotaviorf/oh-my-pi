# DBP Jira — reference cache (Enterprise Engineering)
...
|------|--------|
| **Project key** | `DBP` |
| **Squad (today)** | **Enterprise Engineering** — use this in prompts and docs |
| **Jira display name (legacy)** | *Data Bedrock and People* — former squad name; board/project title unchanged in Jira. **Do not** repeat this full string in agent or user prompts; say **Enterprise Engineering (DBP)** or **DBP** |
