...
## Create DAG files from builder, run local environment, execute automate_dependencies script and copy the dependencies.yaml file (generated by the script)
...
dependencies-file:
	...
	@docker exec airflow-webserver python -m bietlejuice.scripts.dependency_handling.automate_dependencies
	@docker cp airflow-webserver:/bi-etl-ejuice/local/bietlejuice/scripts/dependency_handling/dependencies_with_tasks.yaml dags/dependencies_with_tasks.yaml
