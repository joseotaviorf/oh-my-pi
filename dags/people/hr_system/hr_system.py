...
cluster_description = config_service.get_config("databricks_12_2_med_people_cluster")
...
CUSTOM_LIBRARIES = [
    {
        "whl": f"{artifacts_bucket}/hr-system-api-client-python/quintoandar_hr_system_api_client-0.1.2-py2.py3-none-any.whl"
    }
]
