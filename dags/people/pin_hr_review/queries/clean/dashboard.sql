SELECT
  ...
  extn_metric_value3 AS id_readiness_rating_level,
  extn_metric_calib_value3 AS id_readiness_rating_level_calibrated,
  extn_metric_value4 AS id_criticality_rating_level,
  extn_metric_calib_value4 AS id_criticality_rating_level_calibrated,
  created_by,
