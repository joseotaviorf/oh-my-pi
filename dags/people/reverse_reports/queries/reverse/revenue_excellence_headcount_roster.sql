-- Org-wide headcount roster with termination date (active + terminated),
-- for Revenue Excellence. Mirrors public_information.sql's org-wide scope and
-- pnt_headcount_termination_roster.sql's active+terminated / dt_desligamento
-- logic.
WITH
    dt_inicio_person AS (
        SELECT
