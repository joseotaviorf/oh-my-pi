-- Monthly job-tenure export for other vertical L1 scopes.
...
WHERE
    f.l1_e IN (
        'marco.mordehachvili@quintoandar.com.br',
        'deborah.abisaber@quintoandar.com.br',
        'ana.pellegrini@quintoandar.com.br',
        'l.lima@quintoandar.com.br',
        'marcelo.nelzow@quintoandar.com.br',
        'jaime.macaya@quintoandar.com'
    )
ORDER BY
    nome ASC,
    fechamento ASC
