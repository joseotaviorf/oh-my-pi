...
| **Contract notes** | Legacy column names preserved. Active employees only (including those on approved leave). Campaign window 2026-04-16–2026-07-24 with extended-deadline columns (`dias_ganhos`, `data_limite_bruta`, `nova_data_limite`, etc.). Content completion date (`primeira_data_conclusao`) reflects content grain, not pathway grain. |
