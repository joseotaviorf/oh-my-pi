...
fact_assignment_snapshots_ranked AS (
    SELECT
        ...
        asn.employee_tenure_range,
        asn.days_employee_tenure,
        ...
        asn.is_manager,
        asn.is_active,
        asn.is_effective_worker,
        asn.has_emergency_contact,
        asn.is_transfer_hire,
        asn.is_transfer_termination,
        asn.is_effectivation_hire,
        asn.is_effectivation_termination,
        asn.is_turnover_new_hire,
        asn.is_turnover_termination,
        asn.is_eligible_to_turnover,
        asn.is_primary_assignment_for_snapshot,
        asn.is_reorganization_termination,
        asn.is_monthly_snapshot_for_assignment,
        asn.is_monthly_snapshot_for_employee,
        asn.is_current_for_assignment,
        asn.is_current_for_employee,
        asn.dt_employee_hired,
        asn.dt_assignment_started,
        asn.dt_terminated,
...
SELECT
    ...
    employee_tenure_range,
    days_employee_tenure,
    ...
    is_effectivation_hire,
    is_effectivation_termination,
    is_turnover_new_hire,
    is_turnover_termination,
    is_eligible_to_turnover,
