...
| **Domain** | People |
| **One-line summary** | Daily roster of active employees (work email, assignment number, layer-1 leader's work email, and direct manager's work email) exported as a single CSV object to the Base44 office bucket for the AI Governance team. |
