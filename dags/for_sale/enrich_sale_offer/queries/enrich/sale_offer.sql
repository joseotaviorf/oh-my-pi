...
relation_booking_offer AS (
    SELECT
        ...
        IF(vo.is_3p_demand IS NOT NULL, vo.id_company_demand, bo.id_company_demand) AS id_company_demand,
        IF(vo.is_3p_demand IS NOT NULL, vo.partner_3p_demand, bo.partner_3p_demand) AS partner_3p_demand,
...
SELECT
    ...
    sr.brokerage_fee AS brokerage_fee,
