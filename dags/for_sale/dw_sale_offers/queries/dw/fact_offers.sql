SELECT
    ...
    COALESCE(eso.is_3p_supply, FALSE) AS is_3p_supply,
    COALESCE(eso.is_3p_demand, FALSE) AS is_3p_demand,
    COALESCE(eso.is_3p_lead_gen, FALSE) AS is_3p_lead_gen,
    COALESCE(eso.has_3p_access_control, FALSE) AS has_3p_access_control,
