...
q2aq AS (
    SELECT
        ...
        NULL AS hub_offer,
        CASE
            WHEN (-DATEDIFF(DATE_TRUNC('week',TO_DATE(slf.sk_qualified_date::STRING, 'yyyyMMdd')),DATE_TRUNC('week',TO_DATE(sk_available_qualified_date::STRING, 'yyyyMMdd')))/7)::INT < 20
                THEN 'W'||(-DATEDIFF(DATE_TRUNC('week',TO_DATE(slf.sk_qualified_date::STRING, 'yyyyMMdd')),DATE_TRUNC('week',TO_DATE(sk_available_qualified_date::STRING, 'yyyyMMdd')))/7)::INT
            WHEN (-DATEDIFF(DATE_TRUNC('week',TO_DATE(slf.sk_qualified_date::STRING, 'yyyyMMdd')),DATE_TRUNC('week',TO_DATE(sk_available_qualified_date::STRING, 'yyyyMMdd')))/7)::INT >= 20
                THEN 'W20+'
        END AS weeks_conversion,
        CAST(NULL AS BIGINT) AS p2fc,
...
aq2o AS (
    SELECT
        ...
        NULL AS hub_offer,
        CASE
            WHEN (-DATEDIFF(DATE_TRUNC('week',TO_DATE(slf.sk_available_qualified_date::STRING, 'yyyyMMdd')),DATE_TRUNC('week',TO_DATE(sk_opportunity_date::STRING, 'yyyyMMdd')))/7)::INT < 20
                THEN 'W'||(-DATEDIFF(DATE_TRUNC('week',TO_DATE(slf.sk_available_qualified_date::STRING, 'yyyyMMdd')),DATE_TRUNC('week',TO_DATE(sk_opportunity_date::STRING, 'yyyyMMdd')))/7)::INT
            WHEN (-DATEDIFF(DATE_TRUNC('week',TO_DATE(slf.sk_available_qualified_date::STRING, 'yyyyMMdd')),DATE_TRUNC('week',TO_DATE(sk_opportunity_date::STRING, 'yyyyMMdd')))/7)::INT >= 20
                THEN 'W20+'
        END AS weeks_conversion,
        CAST(NULL AS BIGINT) AS p2fc,
