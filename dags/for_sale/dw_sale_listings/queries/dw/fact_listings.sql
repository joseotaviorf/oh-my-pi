SELECT
  ...
  sl.days_first_booking_to_first_visit_completed,
  sl.days_first_visit_completed_to_first_offer_submitted,
  sl.days_first_offer_submitted_to_first_offer_accepted,
  sl.days_first_offer_accepted_to_first_sale_agreement_signed,
