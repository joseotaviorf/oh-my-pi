...
SELECT 
    ...
    d.longitude,
    i.financing_type,
    i.house_registry_office,
    i.real_estate_registry_office,
    i.iptu_sql_status,
    i.iptu_use_description,
    i.iptu_standard_description,
    i.declared_transaction_value,
    i.reference_appraisal_value,
    i.transmitted_proportion,
    i.proportional_reference_appraisal_value,
    i.adopted_calculation_basis,
    i.financed_value,
    i.land_area_m2,
    i.built_area_m2,
    i.portion_public_road_land_m,
    i.ideal_fraction,
    i.iptu_use_code,
    i.iptu_standard_code,
    i.iptu_registration_year,
    i.numbers_complement,
    i.raw_source_neighborhood,
    i.raw_source_address,
    i.raw_source_complement,
    i.raw_source_reference,
    i.source_file,
    i.source_tab,
    i.month,
    i.year,
