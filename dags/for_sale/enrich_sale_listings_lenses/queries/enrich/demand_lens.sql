WITH bookings AS ( 
  SELECT 
    ...
    id_house,
    visit_fup,
    TO_DATE(ts_created) AS dt_booking,
    TO_DATE(CAST(dt_booking AS TIMESTAMP) + FLOOR((slot_day * 15 / 60)+8) * INTERVAL 1 HOURS + ABS(slot_day * 15 % 60) * INTERVAL 1 MINUTES) AS dt_visit_completed
  FROM
  ...
  SELECT
    ...
    CASE 
      WHEN days_as_published > 90 THEN
        CASE  
          WHEN vbs_last_15_days >= 3 THEN 'D0' 
          WHEN vcs_last_15_days >= 2 THEN 'D0'
          WHEN oss_last_15_days >= 1 THEN 'D0'
          WHEN oas_last_15_days >= 1 THEN 'D0'
          WHEN vbs_last_15_days = 2 THEN 'D1'
          WHEN vbs_last_30_days >= 3 THEN 'D1' 
          WHEN vcs_last_30_days >= 2 THEN 'D1'
          WHEN oss_last_30_days >= 1 THEN 'D1'
          WHEN oas_last_30_days >= 1 THEN 'D1'
          WHEN vbs_last_30_days = 2 THEN 'D2'
          WHEN vbs_last_60_days >= 3 THEN 'D2' 
          WHEN vcs_last_60_days >= 2 THEN 'D2'
          WHEN oss_last_60_days >= 1 THEN 'D2'
          WHEN oas_last_60_days >= 1 THEN 'D2'
          WHEN vbs_last_60_days = 2 THEN 'D3' 
          WHEN vbs_last_90_days >= 3 THEN 'D3' 
          WHEN vcs_last_90_days >= 2 THEN 'D3'
      ...
      WHEN days_as_published <= 90 THEN 
        CASE    
          WHEN vbs_last_15_days >= 1 THEN 'D0' 
          WHEN vcs_last_15_days >= 1 THEN 'D0'
          WHEN oss_last_15_days >= 1 THEN 'D0'
          WHEN oas_last_15_days >= 1 THEN 'D0'
          WHEN vcs_last_30_days >= 1 THEN 'D0'
          WHEN oss_last_30_days >= 1 THEN 'D0'
          WHEN oas_last_30_days >= 1 THEN 'D0'
          WHEN vbs_last_30_days >= 1 THEN 'D1' 
          WHEN vcs_last_60_days >= 1 THEN 'D1'
          WHEN oss_last_60_days >= 1 THEN 'D1'
          WHEN oas_last_60_days >= 1 THEN 'D1'
          WHEN vbs_last_60_days >= 1 THEN 'D2' 
          WHEN vcs_last_90_days >= 1 THEN 'D2'
          WHEN oss_last_90_days >= 1 THEN 'D2'
          WHEN oas_last_90_days >= 1 THEN 'D2'
          WHEN vbs_last_90_days >= 1 THEN 'D3'
...
SELECT 
  ...
  tier,
  CASE 
    WHEN tier = 'D0' THEN 'High Demand'
    WHEN tier = 'D1' THEN 'Good Demand'
    WHEN tier = 'D2' THEN 'Some Demand'
    WHEN tier = 'D3' THEN 'Low Demand'
    WHEN tier = 'D4' THEN 'No Demand'
  END AS tier_name,
  tier_disclaimer,
