SELECT
    ...
    CAST(REPLACE(NULLIF(opportunities, ''), ',', '') AS FLOAT) AS bp_w_oa,
    CAST(REPLACE(NULLIF(first_listings, ''), ',', '') AS FLOAT) AS bp_w_ccv,
...
FROM
    datalake_gsheets_raw.sale_demand_buyer_budget_2025