SELECT -- [ODS] This table was migrated from ODS flow and needs a future refactoring to remove castings and renaming
  ...
  v.cancellation_channel_unified,
  v.cancellation_type,
  ...
  v.visit_request_channel_unified,
  ...
  v.first_supply_answer_channel_unified,
  v.first_tenant_living_answer,
  v.first_tenant_living_answer_channel,
  v.first_tenant_living_answer_channel_unified,
  v.visit_first_confirmed_channel,
  v.visit_first_confirmed_channel_unified,
