...
CREATE TABLE dw_visit.dim_business_model (
    sk_business_model BIGINT GENERATED BY DEFAULT AS IDENTITY,
    business_model STRING,
    ts_load TIMESTAMP
) USING DELTA LOCATION 's3://5a-dw-prod/visit/dim_business_model'
