SELECT
    ...
    taskmaster_id_mod AS mod_id_taskmaster,
    ticket_complexity_level_mod AS mod_ticket_complexity_level,
    buyer_onboarding_taskmaster_id_mod AS mod_id_buyer_onboarding_taskmaster,
    seller_onboarding_taskmaster_id_mod AS mod_id_seller_onboarding_taskmaster,
    buyer_hefesto_portfolio_unit_id_mod AS mod_id_buyer_hefesto_portfolio_unit,
    seller_hefesto_portfolio_unit_id_mod AS mod_id_seller_hefesto_portfolio_unit,
