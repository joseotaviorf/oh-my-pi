...
SELECT
    ...
    -- keeps the double type of the existing dw_bpo_performance.cases_perspective Delta column (the query itself yields decimal(37,6))
    CAST(minutes_first_reply_time_business AS DOUBLE) AS minutes_first_reply_time_business,
