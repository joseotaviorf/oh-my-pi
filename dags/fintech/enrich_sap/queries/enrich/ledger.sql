WITH sap_b1 AS (
    SELECT
        ...
        id_external_payment,
        id_document,
        4hana_id_company AS id_branch,
        account_type,
        4hana_account_number AS account_number,
        account_name,
        series,
        contra_act,
        sap_document_number,
        ...
        accounting_rule,
        accounting_type,
        4hana_transaction_type AS transaction_type,
        user_type,
        source_client,
        comments,
        debit_credit,
        ...
        4hana_cost_center_code AS cost_center_code,
        uuid AS hash,
        dt_created,
        dt_reference,
        dt_due,
