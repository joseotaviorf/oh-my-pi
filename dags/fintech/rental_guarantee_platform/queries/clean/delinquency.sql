SELECT
    ...
    IF (status IN (3,7) AND amount_paid < original_value, original_value - amount_paid, NULL) AS discount_amount,
    active AS is_active,
    valid AS is_valid,
    ...
    IF (active = FALSE, updated_at, CAST (NULL AS DATE)) AS dt_archived,
