WITH ranked AS (
    SELECT
        ...
        day,
        NOW() AS ts_load,
        ROW_NUMBER() OVER(PARTITION BY PAACCT, PAACCTG, PAIDPARC, PABICODIGO, PATIPO ORDER BY MAKE_DATE(year,month,day) DESC) AS rn
...
SELECT
    ...
    bank_digit,
    bank_name,
    company_agency_account_digit,
    charge_barcode,
    charge_instructions,
    payment_location_boleto,
    type_transferor,
    type_transferor_document,
    transferor_document,
    transferor_name,
    drawer_type,
    drawer_document_type,
    drawer_document,
    drawer_name,
    bill_record_sequence_2,
    bill_record_sequence_3,
    is_bill_item_deleted,
    due_amount,
    main_amount,
    interest_amount,
    fine_amount,
    eviction_costs_amount,
    eviction_honorarium_amount,
    entry_title,
    entry_description,
    entry_amount,
    bill_amount,
    bill_discount_amount,
    bill_deductions_amount,
    bill_fees_amount,
    bill_additions_amount,
    bill_total_amount,
    ts_creation,
    ts_due,
    ts_installment_due,
