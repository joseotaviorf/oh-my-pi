SELECT
    ...
    DMQUE AS current_queue,
    DMQUE2 AS current_queue_2,
    DMQUE3 AS current_queue_3,
    DMQUE4 AS current_queue_4,
    DMQUE5 AS current_queue_5,
    DMQUE6 AS current_queue_6,
    DMPREVQ AS previous_queue,
    DMPREVQ2 AS previous_queue_2,
    DMPREVQ3 AS previous_queue_3,
    DMPREVQ4 AS previous_queue_4,
    DMPREVQ5 AS previous_queue_5,
    DMPREVQ6 AS previous_queue_6,
    ...
    DMLABEL1 AS label_1_portfolio_segmentation,
    DMLABEL2 AS label_2_portfolio_segmentation,
    DMLABEL3 AS label_3_portfolio_segmentation,
    DMLABEL4 AS label_4_portfolio_segmentation,
    DMLABEL5 AS label_5_portfolio_segmentation,
    DMLABEL6 AS label_6_portfolio_segmentation,
    ...
    DMQCHGDT AS ts_last_queue_update,
    DMQCHGDT2 AS ts_last_queue_update_2,
    DMQCHGDT3 AS ts_last_queue_update_3,
    DMQCHGDT4 AS ts_last_queue_update_4,
    DMQCHGDT5 AS ts_last_queue_update_5,
    DMQCHGDT6 AS ts_last_queue_update_6,
