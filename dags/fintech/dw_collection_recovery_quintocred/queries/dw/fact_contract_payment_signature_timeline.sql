...
SELECT
    ...
    LAST_VALUE(origin_table) IGNORE NULLS OVER (PARTITION BY sk_propose ORDER BY ref_month ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW) AS memory_origin_table,
