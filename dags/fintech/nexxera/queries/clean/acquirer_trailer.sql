SELECT
    ...
    CAST(col_5 / 100 AS DECIMAL(15,2)) AS sale_installments_net_value,
    CAST(col_6 / 100 AS DECIMAL(15,2)) AS summary_anticipated_value,
    CAST(col_7 / 100 AS DECIMAL(15,2)) AS credit_adjustments_value,
    CAST(col_8 / 100 AS DECIMAL(15,2)) AS debit_adjustments_value,
    CAST(col_9 / 100 AS DECIMAL(15,2)) AS compensated_adjustments_value,
    CAST(col_10 / 100 AS DECIMAL(15,2)) AS legacy_summary_installments_value,
