...
SELECT 
  ...
  id_link_renewal,  
  id_partial_link,  
  COALESCE(arr_id_type_valid, ARRAY(ARRAY(''))) AS id_arr_type_valid,
  COALESCE(arr_id_delinquency_valid, ARRAY(ARRAY(''))) AS id_arr_delinquency_valid,  
  COALESCE(arr_id_type_valid_active, ARRAY(ARRAY(''))) AS id_arr_type_valid_active,  
  COALESCE(arr_id_delinquency_valid_active, ARRAY(ARRAY(''))) AS id_arr_delinquency_valid_active,  
  COALESCE(arr_id_type_archived_valid, ARRAY(ARRAY(''))) AS id_arr_type_archived_valid,  
  COALESCE(arr_id_delinquency_archived_valid, ARRAY(ARRAY(''))) AS id_arr_delinquency_archived_valid,  
  COALESCE(arr_id_type, ARRAY(ARRAY(''))) AS id_arr_type,  
  COALESCE(arr_id_delinquency, ARRAY(ARRAY(''))) AS id_arr_delinquency,  
  COALESCE(arr_id_delinquency_active, ARRAY(ARRAY(''))) AS id_arr_delinquency_active,  
  COALESCE(arr_id_delinquency_archived, ARRAY(ARRAY(''))) AS id_arr_delinquency_archived, 
  cycle,  
  ref_month_renewal,  
  days_step,  
  price_index_type,  
  ...
  COALESCE(arr_dt_created_valid, ARRAY(ARRAY(''))) AS dt_arr_created_valid, 
  COALESCE(arr_dt_paid_valid, ARRAY(ARRAY(''))) AS dt_arr_paid_valid,  
  COALESCE(arr_dt_created_valid_active, ARRAY(ARRAY(''))) AS dt_arr_created_valid_active,  
  COALESCE(arr_dt_due_valid_active, ARRAY(ARRAY(''))) AS dt_arr_due_valid_active,  
  COALESCE(arr_dt_created_archived_valid, ARRAY(ARRAY(''))) AS dt_arr_created_archived_valid,  
  COALESCE(arr_dt_due_archived_valid, ARRAY(ARRAY(''))) AS dt_arr_due_archived_valid,  
  COALESCE(arr_arr_dt_due, ARRAY(ARRAY(''))) AS dt_arr_due,  
  COALESCE(arr_arr_dt_paid, ARRAY(ARRAY(''))) AS dt_arr_paid,  
  COALESCE(arr_dt_created, ARRAY(ARRAY(''))) AS dt_arr_created,   
