...
agg_data AS (
    SELECT 
        ...
        ARRAY_AGG(DISTINCT CASE WHEN mob_delinquency_distance <= 0 THEN arr_id_type ELSE NULL END) AS arr_id_type_valid,
        ARRAY_AGG(DISTINCT CASE WHEN mob_delinquency_distance <= 0 THEN arr_dt_created ELSE NULL END) AS arr_dt_created_valid,
        ARRAY_AGG(DISTINCT CASE WHEN mob_delinquency_distance <= 0 THEN arr_id_delinquency ELSE NULL END) AS arr_id_delinquency_valid,
        ARRAY_AGG(DISTINCT CASE WHEN mob_delinquency_distance <= 0 THEN arr_dt_paid ELSE NULL END) AS arr_dt_paid_valid,
        ...
        ARRAY_AGG(DISTINCT CASE WHEN mob_delinquency_distance <= 0 THEN arr_id_type_active ELSE NULL END) AS arr_id_type_valid_active,
        ARRAY_AGG(DISTINCT CASE WHEN mob_delinquency_distance <= 0 THEN arr_dt_created_active ELSE NULL END) AS arr_dt_created_valid_active,
        ARRAY_AGG(DISTINCT CASE WHEN mob_delinquency_distance <= 0 THEN arr_dt_due_active ELSE NULL END) AS arr_dt_due_valid_active,
        ARRAY_AGG(DISTINCT CASE WHEN mob_delinquency_distance <= 0 THEN arr_id_delinquency_active ELSE NULL END) AS arr_id_delinquency_valid_active,
        ...
        ARRAY_AGG(DISTINCT CASE WHEN mob_delinquency_distance <= 0 THEN arr_id_type_archived ELSE NULL END) AS arr_id_type_archived_valid,
        ARRAY_AGG(DISTINCT CASE WHEN mob_delinquency_distance <= 0 THEN arr_dt_created_archived ELSE NULL END) AS arr_dt_created_archived_valid,
        ARRAY_AGG(DISTINCT CASE WHEN mob_delinquency_distance <= 0 THEN arr_dt_due_archived ELSE NULL END) AS arr_dt_due_archived_valid,
        ARRAY_AGG(DISTINCT CASE WHEN mob_delinquency_distance <= 0 THEN arr_id_delinquency_archived ELSE NULL END) AS arr_id_delinquency_archived_valid,
