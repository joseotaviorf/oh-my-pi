...
raw_spark_job_path = (
    f"{databricks_bietlejuice_repo_path}/spark_jobs/{SOURCE}/load_retsuko_raw.py"
)
...
for table in tables:
    ...
    partition_cols = None if extraction_type == "full" else partition_columns
