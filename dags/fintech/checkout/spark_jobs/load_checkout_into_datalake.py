...
JOB_NAME = "load_checkout_into_datalake"

logging.getLogger("py4j").setLevel(logging.ERROR)
logger = QuintoAndarLogger(JOB_NAME)

BLOCK_LIST = ["change_owner_control", "flyway_schema_history", "permission", "requester_role", "role", "role_permission"]
...
if __name__ == "__main__":
    ...
    conn_config_json = dbutils.secrets.get(
        scope="quintoandar", key=DatabaseEnum.CHECKOUT
    )
