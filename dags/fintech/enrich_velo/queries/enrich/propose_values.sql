...
(
  ...
  SELECT
      ...
      COALESCE((pv.rent_amount + pv.condo_amount + pv.light_amount + pv.iptu_amount + pv.other_amount)*pl.pricing*12,0) AS annual_guarantee,
      pv.rent_amount,
      pv.condo_amount,
      pv.light_amount,
      ...
      pv.iptu_amount,
      pv.other_amount,
      pv.rent_amount + pv.condo_amount + pv.light_amount + pv.iptu_amount + pv.other_amount AS total_package_amount,
