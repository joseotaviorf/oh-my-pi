...
SELECT DISTINCT
    ...
    CASE
        ...
        WHEN UPPER(COALESCE(ag.agency_name, agg.agency_name, u.id_user)) LIKE "%GRB%" THEN "BULGARELLI"
        WHEN UPPER(COALESCE(ag.agency_name, agg.agency_name, u.id_user)) LIKE "%BGR%" THEN "BULGARELLI"
        WHEN UPPER(COALESCE(ag.agency_name, agg.agency_name, u.id_user)) LIKE "%BULGARELLI%" THEN "BULGARELLI"
        ...
        WHEN UPPER(COALESCE(ag.agency_name, agg.agency_name, u.id_user)) LIKE "%PLC%" THEN "LLC"
        WHEN UPPER(COALESCE(ag.agency_name, agg.agency_name, u.id_user)) LIKE "%LLC%" THEN "LLC"
