...
campaign_discount AS (
  SELECT
    ...
    SUM(IF(field_name IN ("Custas Residuais", "Custas Acordo", "Honorários Residuais", "Despesas judiciais"), discount, 0)) AS discount_to_eviction_costs,
...
SELECT
    ...
    CASE
      ...
      WHEN UPPER(COALESCE(agg.agency_name, ag.agency_name, a.id_user)) LIKE "%PLC%" THEN "LLC"
      WHEN UPPER(COALESCE(agg.agency_name, ag.agency_name, a.id_user)) LIKE "%LLC%" THEN "LLC"
