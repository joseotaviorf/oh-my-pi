  ...
  FROM (
    SELECT
      ...
      CASE
        ...
        WHEN UPPER(n.consultancy_name) IN ("PASCHOALOTTO", "MEETCALL", "TRC", "GRB", "BULGARELLI", "MONEST", "PELLON", "PLC", "LLC", "GONDIM", "NOVAQUEST") THEN "Assessoria"
      ...
      n.negotiation_discount_amount AS discount_amount,
      ...
      ROW_NUMBER() OVER(
        PARTITION BY n.id_contract, n.id_negotiation_external
        ORDER BY n.ts_created_at DESC, cl.ts_created DESC
      ) AS rn
...
recupera_negotiation AS (
  ...
  FROM (
    SELECT
      ...
      rn.expense_amount AS total_debt_amount,
