...
DAG_ID = f"bietlejuice.{SOURCE}_integration_report"
...
config_service = ConfigurationService(f"{SOURCE}_integration_report")
...
raw_spark_job_path = f"{databricks_bietlejuice_repo_path}/spark_jobs/{SOURCE}_integration_report/load_{{extraction_type}}_{SOURCE}_raw.py"
...
task_group = DatalakeTaskGroup(
    ...
    relative_query_path=f"{SOURCE}_integration_report",
