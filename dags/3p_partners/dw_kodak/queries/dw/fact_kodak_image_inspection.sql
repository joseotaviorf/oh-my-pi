...
SELECT
  ...
  im.width,
  im.is_approved,
  ig.has_bonus_aspect_ratio,
  ig.has_bonus_external,
  ig.has_bonus_good_sharpness,
  ig.has_bonus_images_per_room,
  ...
  ig.has_red_flag_images_per_room,
  im.has_red_flag_media_modification,
  im.has_red_flag_not_property,
  ig.has_red_flag_primary_risk,
  ig.has_red_flag_property_condition,
