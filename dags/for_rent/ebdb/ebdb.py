...
def clean_tasks(table_name):
    ...
    clean_table_task = QuintoAndarDatabricksSubmitRunOperator(databricks_conn_id="databricks_default", dag=dag,
    ...
    sync_metastore_clean_table_structure_task = QuintoAndarDatabricksSubmitRunOperator(databricks_conn_id="databricks_default", dag=dag,
    ...
    if DAGMetadataService.metadata_file_exists(
        ...
        propagate_table_metadata_task = QuintoAndarDatabricksSubmitRunOperator(databricks_conn_id="databricks_default", dag=dag,
...
def build_raw_task_list():
    ...
    :rtype: List[str]
    """
    load_tables_into_datalake_task = QuintoAndarDatabricksSubmitRunOperator(databricks_conn_id="databricks_default", task_id="load-tables-to-datalake-raw",
        dag=dag,
        json={
            "spark_python_task": {
...
polygon_region_raw_task = QuintoAndarDatabricksSubmitRunOperator(databricks_conn_id="databricks_default", dag=dag,
...
sync_metastore_table_structure_task = QuintoAndarDatabricksSubmitRunOperator(databricks_conn_id="databricks_default", dag=dag,
...
propagate_table_lineage_task = QuintoAndarDatabricksSubmitRunOperator(databricks_conn_id="databricks_default", dag=dag,
...
for tb_name in tb_names:
    ...
    data_quality_tests_task = QuintoAndarDatabricksSubmitRunOperator(databricks_conn_id="databricks_default", dag=dag,
