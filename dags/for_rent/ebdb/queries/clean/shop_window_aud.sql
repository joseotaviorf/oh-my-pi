SELECT
    ...
    demandContactSubmissionId AS id_demand_contact_submission,
    ...
    demandContactSubmissionId_MOD AS mod_id_demand_contact_submission,
...
FROM
    datalake_ebdb_raw.shopwindow_aud