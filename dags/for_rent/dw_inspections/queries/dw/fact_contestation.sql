...
SELECT DISTINCT
    ...
    reviewer_type = 'TENANT' AND origin = 'BUDGET_APPROVAL' AS is_tenant_budget_approval_contestation,
    reviewer_type = 'OWNER' AND origin = 'BUDGET_APPROVAL' AS is_owner_budget_approval_contestation,
    c.ts_created,
    c.ts_updated,
    NOW() AS ts_load,
    c.year,
