...
JOB_NAME = "load_incremental_property_tax_raw"
...
if __name__ == "__main__":
    ...
    logger.info(
        f"""
                ...
                table_name={table_name}, data_column={date_column}, execution_date={execution_date},
                msg=Starting incremental Spark job...
        """
    )
    ...
    conn_config_json = dbutils.secrets.get(scope="quintoandar", key=DatabaseEnum.PROPERTY_TAX)
