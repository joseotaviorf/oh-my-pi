...
# TODO: When finished ODS migration to Janus schema, model dim_user_sales_rep should
# be placed on DAG dw_user and this one should be deleted.

# Pipeline inputs
DW_SCHEMA = "quintoandar"
CONTEXT = "user_sales_rep"
