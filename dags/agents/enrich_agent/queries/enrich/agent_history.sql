...
SELECT
    ...
    MAX(COALESCE(agent_bc.is_allow_demand_sale, agent_cap.is_allow_demand_sale, FALSE)) AS is_allow_demand_sale,
    MAX(COALESCE(agent_bc.is_allow_demand_rent, agent_cap.is_allow_demand_rent, FALSE)) AS is_allow_demand_rent,
