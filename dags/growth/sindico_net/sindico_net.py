...
ENTITIES = config_service.get_config("entities")
...
for entity in ENTITIES:
    ...
    raw_spark_job_file = (
        f"{databricks_bietlejuice_repo_path}/spark_jobs/{SOURCE}/load_{entity}_raw.py"
    )
    ...
    raw_task_group = datalake_task_group.build_raw_task_group_for_single_table(
        ...
        raw_spark_job_extra_args=[
            SOURCE,
            entity,
            "{{ get_date_param(dag_run, ds, 'load_date') }}"
        ],
    )
