...
if __name__ == "__main__":
    ...
    key = [secret for secret in all_keys if secret['app_id'] == 183047][0]
    ...
    transient_path = transient_location + f'183047/183047_{execution_date}_*/'
    ...
    try:
        ...
        if not(df.isEmpty()):
            ...
            logger.info(f'msg=Partitions added {key["app_id"]} for this day.')
