SELECT 
    ...
    event_properties,
    user_properties,
    get_json_object(event_properties, '$.selected_strategy') ep_selected_strategy,
    is_paying,
    ...
    day
FROM 
    datalake_amplitude_clean_staging.183047_ad_improvements_price_strategy_button_clicked_events
WHERE  
    year={} 
    AND month = {} 
    AND day = {}