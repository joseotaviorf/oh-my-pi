CREATE OR REPLACE VIEW datalake_amplitude_clean_prod."205027_login_confirmation_viewed_events" AS
    SELECT
        *,
    ...
    FROM
        datalake_amplitude_clean_staging_prod."205027_login_confirmation_viewed_events";
