...
mid_table AS (
  SELECT
    ...
    NVL2(oa.utm_campaign, 'cdp', NVL2(a.campaign, 'amplitude', NVL2(inbound_leads.utm_campaign, 'facebook_api', 'lost_tracking'))) AS database_tracking_campaign,
    NVL2(oa.utm_medium, 'cdp', NVL2(a.medium, 'amplitude', NVL2(inbound_leads.utm_medium, 'facebook_api', 'lost_tracking'))) AS database_tracking_medium,
    NVL2(oa.utm_source, 'cdp', NVL2(a.source, 'amplitude', NVL2(inbound_leads.utm_source, 'facebook_api', 'lost_tracking'))) AS database_tracking_source,
    NVL2(oa.utm_content, 'cdp', NVL2(a.content, 'amplitude', NVL2(inbound_leads.utm_content, 'facebook_api', 'lost_tracking'))) AS database_tracking_content,
    NVL2(oa.utm_term, 'cdp', NVL2(a.term, 'amplitude', NVL2(inbound_leads.utm_term, 'facebook_api', 'lost_tracking'))) AS database_tracking_term,
