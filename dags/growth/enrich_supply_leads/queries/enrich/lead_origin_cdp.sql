...
mid_table AS (
  SELECT
    ...
    cdp.egw_utm_campaign AS campaign,
    COALESCE(
      cdp.egw_utm_medium,
      CASE
    ...
    cdp.egw_utm_content AS content,
    cdp.egw_utm_term AS term,
    r.ops_agent,
    r.ops_partner,
    r.application,
    r.city,
    ...
    ia.url_source_ctwa,
    ia.type_source_ctwa,
    NVL2(cdp.egw_utm_campaign, 'cdp', 'lost_tracking') AS database_tracking_campaign,
    NVL2(cdp.egw_utm_medium, 'cdp', NVL2(cdp.egw_referrer_domain, 'cdp_referrer', 'lost_tracking')) AS database_tracking_medium,
    NVL2(cdp.egw_utm_source, 'cdp', NVL2(cdp.egw_referrer_domain, 'cdp_referrer', 'lost_tracking')) AS database_tracking_source,
    NVL2(cdp.egw_utm_content, 'cdp', 'lost_tracking') AS database_tracking_content,
    NVL2(cdp.egw_utm_term, 'cdp', 'lost_tracking') AS database_tracking_term,
