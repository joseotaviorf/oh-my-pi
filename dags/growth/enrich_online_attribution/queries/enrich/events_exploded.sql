WITH events_filtered AS (
    SELECT
        ...
        FROM_JSON(user_properties,'
                ...
                `[adjust] network` STRING,
                `[AppsFlyer] campaign` STRING,
                `[AppsFlyer] media source` STRING,
                `[AppsFlyer] channel` STRING,
                `[AppsFlyer] installed at` STRING,
                `[AppsFlyer] adset` STRING,
                `[AppsFlyer] ad` STRING') AS user_properties,
        year,
        month,
        day
    FROM
...
SELECT
    ...
    user_properties.`[AppsFlyer] campaign` AS appsflyer_campaign,
    user_properties.`[AppsFlyer] media source` AS appsflyer_media_source,
    user_properties.`[AppsFlyer] channel` AS appsflyer_channel,
    user_properties.`[AppsFlyer] installed at` AS appsflyer_installed_at,
    user_properties.`[AppsFlyer] adset` AS appsflyer_adset,
    user_properties.`[AppsFlyer] ad` AS appsflyer_ad,
