...
SELECT
    ...
    sv.ccv::BIGINT,
    sv.potential_closed_deals::DOUBLE,
    sv.sale_price_agreed::DOUBLE,
    st.ccv_target::DOUBLE,
    st.potential_closed_deals_target::DOUBLE,
    mc.demand_cost::DOUBLE,
    mc.supply_cost::DOUBLE,
    mc.branding_cost::DOUBLE,
    mc.demand_budget::DOUBLE,
    mc.supply_budget::DOUBLE,
    mc.branding_budget::DOUBLE,
    sa.amortized_supply_cost::DOUBLE,
    sa.amortized_supply_budget::DOUBLE,
    da.amortized_demand_cost::DOUBLE,
    da.amortized_demand_budget::DOUBLE,
    ab.amortized_branding_supply_share::DOUBLE,
    abd.amortized_branding_demand_share::DOUBLE,
    ab.amortized_branding_supply_budget::DOUBLE,
    abd.amortized_branding_demand_budget::DOUBLE
FROM
