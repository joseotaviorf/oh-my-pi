...
sale_offer_attribution AS (
  SELECT
    ...
    IF(acc.visit_code IS NOT NULL, acc.final_attribution_content, sor.utm_content) AS utm_content,
    IF(acc.visit_code IS NOT NULL, acc.final_attribution_entrance_uri, sor.entrance_uri) AS entrance_uri,
...
rent_offer_attribution AS (
  SELECT
    ...
    IF(acc.visit_code IS NOT NULL, acc.final_attribution_content, aos.utm_content) AS utm_content,
    IF(acc.visit_code IS NOT NULL, acc.final_attribution_entrance_uri, aos.entrance_uri) AS entrance_uri,
