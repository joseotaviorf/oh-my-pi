...
rent_offer_attribution AS (
  ...
  LEFT JOIN
    datalake_amplitude_offer.offer_submitted_events AS aos
      ON roce.id_offer = aos.id_firestore
...
legacy_data_talk_to_agent AS (
    SELECT
      ...
      NULL AS first_update_source,
      NULL AS flg_via_reschedule,
      a.app_type,
      a.utm_medium,
      a.utm_source,
      a.utm_campaign,
...
events_with_attribution AS (
  ...
  SELECT
    ...
    id_agent,
    business_context,
    NULL AS user_sale_booking_creator,
    NULL AS first_update_source,
    NULL AS flg_via_reschedule,
    app_type,
    utm_medium,
...
SELECT
  ...
  e.id_agent,
  e.business_context,
  e.user_sale_booking_creator,
  e.first_update_source,
  e.flg_via_reschedule,
  e.app_type,
  e.utm_medium,
  e.utm_source,
  e.utm_campaign,
