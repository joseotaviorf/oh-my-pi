...
MAIN_START_DATE = datetime(2024, 1, 10, tzinfo=timezone("America/Sao_Paulo"))
MAIN_SCHEDULE_INTERVAL = "0 11 * * *"
CLUSTER_DESCRIPTION = "databricks_10_4_med_compute_cluster"
...
tables_config = config_service.get_config("tables_config")
...
for table in tables_config:
    ...
    raw_task_group = datalake_task_group.build_raw_task_group_for_single_table(
        ...
        table_name=tables_config[table]['raw_table_name'].lower(),
    ...
    clean_task_group = datalake_task_group.build_clean_task_group(
        ...
        target_database_base_name=SOURCE,
        table_name=tables_config[table]['clean_table_name'],
