...
SELECT
    ...
    CAST(NULL AS BIGINT) AS n_user_turns_until_first_recommendation,
    CAST(NULL AS BIGINT) AS n_user_turns_until_visit_intent,
    ...
    CAST(NULL AS BIGINT) AS n_recommendations_shown,
    ...
    CAST(NULL AS BIGINT) AS total_input_tokens,
    CAST(NULL AS BIGINT) AS total_output_tokens,
    lsa.avg_llm_response_time_ms,
    lsa.p50_llm_response_time_ms,
    lsa.p95_llm_response_time_ms,
    CAST(NULL AS STRING) AS full_conversation,
    ls.ts_created,
    ls.ts_closed,
    lsa.ts_first_turn,
    lsa.ts_last_turn,
