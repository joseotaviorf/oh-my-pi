...
The file [dw_datamarts_growth_dep_manual_costs_prod_conf.yml](https://github.com/quintoandar/bi-etl-ejuice/blob/master/bietlejuice/dags/dw_datamarts/growth/dw_datamarts_growth_dep_manual_costs_prod_conf.yml)
