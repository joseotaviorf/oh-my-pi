SELECT
    ...
    id_service,
    CAST(GET_JSON_OBJECT(inputs, '$.request.id_house') AS BIGINT) AS id_house,
    CAST(GET_JSON_OBJECT(inputs, '$.request.id_user') AS BIGINT) AS id_user,
    CAST(GET_JSON_OBJECT(inputs, '$.request.id_entity') AS STRING) AS id_entity,
