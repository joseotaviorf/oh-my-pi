...
def transform_payload(database_name, table_name):
    ...
    df = df.select(
        ["sk_house", "classified_score_rent", "classified_score_sale", "dt_snapshot"]
    )

    df = (
        df.withColumnRenamed("sk_house", "houseId")
    ...
    payload = [
        {
            ...
            "payload": {
                "houseId": row["houseId"],
                "rentClassifiedsRankingScore": row["rentClassifiedsRankingScore"],
                "saleClassifiedsRankingScore": row["saleClassifiedsRankingScore"],
            },
        }
