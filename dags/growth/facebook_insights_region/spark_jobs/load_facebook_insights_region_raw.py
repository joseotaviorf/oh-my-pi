...
JOB_NAME = "load_facebook_insights_region_raw"
...
def facebook_insights_request(account_id, table_name, start_date, end_date, breakdown):
    ...
    try:
        insights_list = [
            insight.export_all_data() for insight in async_job.get_result()
        ]
...
def main():
    ...
    insights_list = facebook_insights_request(
        account_id, table_name, load_start_date, load_end_date, breakdown
    )
