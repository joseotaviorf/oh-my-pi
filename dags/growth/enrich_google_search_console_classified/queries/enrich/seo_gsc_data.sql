 ...
 CASE
    ...
    WHEN page LIKE '%www.urbania.pe%' THEN 'Transactional'
    WHEN page LIKE '%www.adondevivir.pe%' THEN 'Transactional'
    WHEN page LIKE '%www.compreoalquile.com%' THEN 'Transactional'
    WHEN page LIKE '%www.casamineira.com%' THEN 'Transactional'
  ELSE NULL END AS struct
 FROM
