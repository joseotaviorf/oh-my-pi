...
That's a working progress DAG. Consolidated Growth Metrics DAG groups marketing metrics for QuintoAndar's media channels, but apply changes for new taxonomy project.
...
- In datalake's `enrich` layer:
    - `datalake_consolidated_growth_metrics.consolidated_media_metrics`
