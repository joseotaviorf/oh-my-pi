...
source_path = 'amplitude_demand_tests'
...
events_to_datalake_raw_task = QuintoAndarDatabricksSubmitRunOperator(
    task_id="events-demand-test-to-datalake-raw",
    dag=dag,
    json={
        "spark_python_task": {
            "python_file": raw_spark_jobs_path + "load_amplitude_demand_tests_raw.py",
