SELECT
    ...
    NULLIF(GET_JSON_OBJECT(properties, '$.cons_agent_simulation_value'), '') AS consorcio_agent_simulation_value,
    NULLIF(GET_JSON_OBJECT(properties, '$.cons_valor_em_negociacao'), '') AS consorcio_negotiation_value,
    NULLIF(GET_JSON_OBJECT(properties, '$.cons_blip_inatividade_ia'), '') AS consorcio_blip_agent_inactivity,
    NULLIF(GET_JSON_OBJECT(properties, '$.cons_feedback_survey'), '') AS consorcio_feedback_survey,
    NULLIF(GET_JSON_OBJECT(properties, '$.cons_codigos_das_propostas'), '') AS consorcio_bamaq_proposal_codes,
    NULLIF(GET_JSON_OBJECT(properties, '$.cons_abandono_c2w'), '') AS consorcio_abandoned_cart_template_sent,
    is_archived,
