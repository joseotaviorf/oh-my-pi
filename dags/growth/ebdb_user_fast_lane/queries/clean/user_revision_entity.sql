SELECT
    ...
    Ex: 20220801123000 for 2022-08-01T12-30-00

    With this, when the unixtime comes in too high, we will transform it before making the changes.
    */
    IF(timestamp < 20000000000000, timestamp, UNIX_TIMESTAMP(CAST(timestamp AS STRING), 'yyyyMMddHHmmss') * 1000) AS ts_revision,
