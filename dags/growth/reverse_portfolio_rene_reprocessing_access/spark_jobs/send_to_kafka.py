...
JOB_NAME = "send_historical_rene_lead_to_kafka"
    ...
    try:
        ...
        while current_date < end_date:
            ...
            try:
                ...
                created_at_type = dict(df.dtypes)["createdAt"]
                ...
                send_data_to_kafka(df, kafka_key_column, kafka_topic, kafka_api_key, kafka_api_secret, kafka_bootstrap_servers)
...
if __name__ == "__main__":
    ...
    try:
        ...
        config_service = ConfigurationService("reverse_portfolio_rene_reprocessing_access")
        topic_sufix = config_service.get_config("topic_sufix")
        kafka_key_column = "leadId"
        ...
        full_table_name = f"quintoandar_{arguments.environment}.reverse_lead_portfolio_rene_reprocessing.{table_name}"
