...
def get_access_token(url):
    ...
    api_credentials = json.loads(
        get_dbutils().secrets.get(scope="quintoandar", key=APIEnum.SALESFORCE_GROWTH)
    )
        ...
        "lead": {
            "schema": StructType(
                [
                    ...
                    StructField(
                        "Zona_Barrio_Colonia_Comuna_facturacion2__c", StringType()
                    ),
                    ...
                    StructField(
                        "whatslly__Last_WhatsApp_Message_Time__c", StringType()
                    ),
                    ...
                    StructField(
                        "Codigo_de_la_propiedad_registrada_Id_IM__c", StringType()
                    ),
        ...
        "operation": {
            "schema": StructType(
                [
                    ...
                    StructField(
                        "Renovacion_automatica_de_oportunidades__c", StringType()
                    ),
        ...
        "user": {
            "schema": StructType(
                [
                    ...
                    StructField(
                        "UserPreferencesEventRemindersCheckboxDefault", StringType()
                    ),
                    StructField(
                        "UserPreferencesTaskRemindersCheckboxDefault", StringType()
                    ),
                    ...
                    StructField(
                        "UserPreferencesDisableChangeCommentEmail", StringType()
                    ),
                    StructField(
                        "UserPreferencesDisableLaterCommentEmail", StringType()
                    ),
                    StructField("UserPreferencesDisProfPostCommentEmail", StringType()),
                    StructField(
                        "UserPreferencesHideCSNGetChatterMobileTask", StringType()
                    ),
                    StructField(
                        "UserPreferencesDisableMentionsPostEmail", StringType()
                    ),
                    StructField("UserPreferencesDisMentionsCommentEmail", StringType()),
                    StructField("UserPreferencesHideCSNDesktopTask", StringType()),
                    StructField(
                        "UserPreferencesHideChatterOnboardingSplash", StringType()
                    ),
                    StructField(
                        "UserPreferencesHideSecondChatterOnboardingSplash", StringType()
                    ),
                    StructField(
                        "UserPreferencesDisCommentAfterLikeEmail", StringType()
                    ),
                    ...
                    StructField(
                        "UserPreferencesActionLauncherEinsteinGptConsent", StringType()
                    ),
                    StructField(
                    ...
                    StructField(
                        "UserPreferencesShowTitleToExternalUsers", StringType()
                    ),
                    StructField(
                        "UserPreferencesShowManagerToExternalUsers", StringType()
                    ),
                    StructField(
                        "UserPreferencesShowEmailToExternalUsers", StringType()
                    ),
                    StructField(
                        "UserPreferencesShowWorkPhoneToExternalUsers", StringType()
                    ),
                    StructField(
                        "UserPreferencesShowMobilePhoneToExternalUsers", StringType()
                    ),
                    StructField("UserPreferencesShowFaxToExternalUsers", StringType()),
                    StructField(
                        "UserPreferencesShowStreetAddressToExternalUsers", StringType()
                    ),
                    StructField("UserPreferencesShowCityToExternalUsers", StringType()),
                    StructField(
                        "UserPreferencesShowStateToExternalUsers", StringType()
                    ),
                    StructField(
                        "UserPreferencesShowPostalCodeToExternalUsers", StringType()
                    ),
                    StructField(
                        "UserPreferencesShowCountryToExternalUsers", StringType()
                    ),
                    StructField(
                        "UserPreferencesShowProfilePicToGuestUsers", StringType()
                    ),
                    ...
                    StructField(
                        "UserPreferencesShowPostalCodeToGuestUsers", StringType()
                    ),
                    StructField("UserPreferencesShowCountryToGuestUsers", StringType()),
                    StructField(
                        "UserPreferencesShowForecastingChangeSignals", StringType()
                    ),
                    StructField(
                        "UserPreferencesLiveAgentMiawSetupDeflection", StringType()
                    ),
                    ...
                    StructField(
                        "UserPreferencesShowWorkPhoneToGuestUsers", StringType()
                    ),
                    StructField(
                        "UserPreferencesShowMobilePhoneToGuestUsers", StringType()
                    ),
                    StructField("UserPreferencesShowFaxToGuestUsers", StringType()),
                    StructField(
                        "UserPreferencesShowStreetAddressToGuestUsers", StringType()
                    ),
                    StructField(
                        "UserPreferencesLightningExperiencePreferred", StringType()
                    ),
                    StructField(
                    ...
                    StructField(
                        "UserPreferencesHideLightningMigrationModal", StringType()
                    ),
                    ...
                    StructField(
                        "UserPreferencesGlobalNavGridMenuWTShown", StringType()
                    ),
                    StructField("UserPreferencesCreateLEXAppsWTShown", StringType()),
                    StructField("UserPreferencesFavoritesWTShown", StringType()),
                    StructField(
                        "UserPreferencesRecordHomeSectionCollapseWTShown", StringType()
                    ),
                    StructField(
                        "UserPreferencesRecordHomeReservedWTShown", StringType()
                    ),
                    StructField(
                        "UserPreferencesFavoritesShowTopFavorites", StringType()
                    ),
                    StructField(
                        "UserPreferencesExcludeMailAppAttachments", StringType()
                    ),
                    StructField(
                        "UserPreferencesSuppressTaskSFXReminders", StringType()
                    ),
                    StructField(
                        "UserPreferencesSuppressEventSFXReminders", StringType()
                    ),
                    ...
                    StructField(
                        "UserPreferencesReverseOpenActivitiesView", StringType()
                    ),
                    ...
                    StructField(
                        "UserPreferencesHideOnlineSalesAppWelcomeMat", StringType()
                    ),
                    StructField(
                        "UserPreferencesShowForecastingRoundedAmounts", StringType()
                    ),
                    ...
                    StructField(
                        "et4ae5__ExactTargetForAppExchangeAdmin__c", StringType()
                    ),
                    StructField(
                        "et4ae5__ExactTargetForAppExchangeUser__c", StringType()
                    ),
...
def main():
    ...
    while is_done == False:
        df, is_done, next_url = get_next_page_data(
            query, headers, instance_url, table_name, is_done, next_url
        )
