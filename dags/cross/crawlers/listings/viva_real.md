## Viva Real
### Purpose
This DAG ingests data from Viva Real crawled data made by our partners. The data is placed on a S3 bucket and this day gets the JSONs imputed with one week of interval (D-7).
