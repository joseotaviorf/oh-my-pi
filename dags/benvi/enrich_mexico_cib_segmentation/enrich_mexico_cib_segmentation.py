...
MAIN_START_DATE = datetime(2022, 5, 1, 0, 0, 0, tzinfo=LOCAL_TZ)

CONTEXT = "mexico_cib_segmentation"
...
chain(skip_run_task, create_cluster_task, DatalakeTaskGroup.all_first_tasks(enrich_task_groups))
