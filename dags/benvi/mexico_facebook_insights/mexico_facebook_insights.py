...
SOURCE = "mexico_facebook_insights"
...
MAIN_START_DATE = datetime(2022, 5, 30, tzinfo=timezone("America/Mexico_City"))
MAIN_SCHEDULE_INTERVAL = "0 0 * * *"
RAW_SPARK_JOB_FILE = f"{DATABRICKS_BIETLEJUICE_REPO_PATH}/spark_jobs/{SOURCE}/load_mexico_facebook_insights_raw.py"
