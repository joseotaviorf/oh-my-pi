WITH contracts AS (
  SELECT
    ...
    turf.id_user_activity AS sk_user_activity,
    ...
    turf.ticket_number_activity,
    turf.discount_months_activity,
    turf.discount_percentage_activity,
    turf.discount_amount_activity,
    turf.discounted_rental_activity,
    turf.rental_amount_activity,
    ...
    turf.ts_activity_transferred,
    turf.ts_activity_requested,
    turf.ts_activity_transition_created,
    turf.year,
    turf.month,
    turf.day
  FROM
...
SELECT DISTINCT
  ...
  c.ticket_number_activity,
  c.discount_months_activity,
  c.discount_percentage_activity,
  c.discount_amount_activity,
  c.discounted_rental_activity,
  c.rental_amount_activity,
  c.action_user_name,
  c.action_type,
  c.type_activity,
  c.task_action_type,
  ...
  c.ts_activity_transferred,
  c.ts_activity_requested,
  c.ts_activity_transition_created,
  NOW() AS ts_load,
  c.year,
  c.month,
  c.day
