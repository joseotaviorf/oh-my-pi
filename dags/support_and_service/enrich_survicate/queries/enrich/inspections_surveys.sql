SELECT
    ...
    CAST(LAST(rc.answer_content) FILTER (WHERE rc.id_question IN (1835806, 1926509)) AS INT) AS satisfaction_score,
    "satisfaction evaluation" AS score_description,
    CAST(LAST(rc.answer_content) FILTER (WHERE rc.id_question = 1835786) AS INT) AS secondary_satisfaction_score,
