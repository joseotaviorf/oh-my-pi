WITH
 ...
 fact_ticket_csat AS (
    ...
    SELECT
      ...
      seg.total_talk_time,
      seg.bot,
      to_timestamp(ft.ts_latest_customer_comment) - interval '3' hour AS ts_latest_customer_comment,
      to_timestamp(ft.ts_latest_analyst_comment) - interval '3' hour AS ts_latest_analyst_comment,
      seg.ts_task_created,
      ft.ts_created,
      ft.ts_updated,
      CASE
