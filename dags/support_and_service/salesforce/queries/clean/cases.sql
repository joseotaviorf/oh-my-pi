SELECT
    ...
    OmniChannelQueue__c AS case_omnichannel_queue,
    Mediation__c AS case_mediation,
    ...
    CAST(isEviction__c AS BOOLEAN) AS is_eviction,
    CAST(isHighValue__c AS BOOLEAN) AS is_high_value,
    CAST(isPPMulti__c AS BOOLEAN) AS is_pp_multi,
