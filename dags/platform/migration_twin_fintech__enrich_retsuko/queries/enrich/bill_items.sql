...
SELECT
    ...
    CASE
      ...
      WHEN bi.bill_item IN ('RESIDENTIAL-PROTECTION-5A-ACQUITTANCE','RESIDENTIAL-PROTECTION-5A-FUND-TRANSFER', 'REPAIR-WORK','REPAIR-OFFBOARDING', 'REPAIR-ONGOING') THEN 'REPAROS'
