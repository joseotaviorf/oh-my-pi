...
SELECT
  ...
  YEAR(TO_DATE(stage_struct.updated_at)) AS year,
  MONTH(TO_DATE(stage_struct.updated_at)) AS month,
  DAY(TO_DATE(stage_struct.updated_at)) AS day
FROM exploded_stages