...
MAIN_SCHEDULE_INTERVAL = "30 * * * *"

CONTEXT = "granulate_stress_test"
DAG_NAME = f"{CONTEXT}_12_2_all_purpose"
...
authorize_ips_task = QuintoAndarDatabricksSubmitRunOperator(
    databricks_conn_id="databricks_job_cluster",
    dag=dag,
...
interact_with_metastore_task = QuintoAndarDatabricksSubmitRunOperator(
    databricks_conn_id="databricks_job_cluster",
    dag=dag,
...
create_cluster_task >> authorize_ips_task >> interact_with_metastore_task >> terminate_cluster_task
