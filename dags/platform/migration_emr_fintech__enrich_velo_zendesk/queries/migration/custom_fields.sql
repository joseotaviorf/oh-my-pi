...
GROUP BY 1
    ...
    SELECT
        ...
        CAST(base.custom_fields['Realizada 3ª ligação - Data'] AS DATE) AS dt_third_call,
        CAST(base.custom_fields['WhatsApp 1º - Data'] AS DATE) AS dt_first_whatsapp,
        CAST(base.custom_fields['WhatsApp 2º - Data'] AS DATE) AS dt_second_whatsapp,
        CAST(base.custom_fields['WhatsApp 3º - Data'] AS DATE) AS dt_third_whatsapp,
