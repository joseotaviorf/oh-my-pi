WITH negotiation_data AS (
  ...
  LEFT JOIN datalake_recupera.contract_advisory_distribution AS rc
    ON o.id_contract = rc.id_contract AND o.dt_reference = rc.dt_snapshot
  LEFT JOIN datalake_cyber.agency_timeline AS cad
    ON o.id_contract = cad.id_contract AND o.dt_reference = cad.dt_reference
  LEFT JOIN datalake_cyber.queue_timeline AS q
    ON o.id_contract = q.id_contract_external AND o.dt_reference = q.dt_reference
