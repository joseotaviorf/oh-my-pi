SELECT
  ...
  DATEDIFF(TO_DATE(o.ts_first_iteration), TO_DATE(o.ts_last_iteration)) AS days_of_negotiation,
  ...
  o.ts_last_iteration,
  NOW() AS ts_load
FROM datalake_rental_transact.offer AS o
JOIN datalake_ebdb_listing.house_listing AS hl
  ON hl.id_house = o.id_house
  AND COALESCE(o.ts_created, '1900-01-01') BETWEEN COALESCE(hl.ts_listing_version_start, '1900-01-01') AND COALESCE(hl.ts_listing_version_end, NOW())