  ...
  FROM (
    SELECT
      ...
      CAST(GET_JSON_OBJECT(
        ...
        ARRAY(0).startTime.iso8601
      ) AS TIMESTAMP) AS ts_sla_first_response_started, /* time_to_first_response */
      CAST(GET_JSON_OBJECT(
        GET_JSON_OBJECT(fields, customfield_10222.completedCycles),
        ARRAY(0).stopTime.iso8601
      ) AS TIMESTAMP) AS ts_sla_first_response_completed,
      CAST(GET_JSON_OBJECT(
        GET_JSON_OBJECT(fields, customfield_10222.completedCycles),
        ARRAY(0).breachTime.iso8601
      ) AS TIMESTAMP) AS ts_sla_first_response_breach_limit,
      CAST(GET_JSON_OBJECT(GET_JSON_OBJECT(fields, customfield_10222.completedCycles), ARRAY(0).breached) AS BOOLEAN) AS is_sla_first_response_breached,
      CAST(GET_JSON_OBJECT(
        GET_JSON_OBJECT(fields, customfield_10222.completedCycles),
        ARRAY(0).goalDuration.millis
      ) AS BIGINT) / 3600000 AS sla_first_response_goal_hours,
      CAST(GET_JSON_OBJECT(
        GET_JSON_OBJECT(fields, customfield_10222.completedCycles),
        ARRAY(0).elapsedTime.millis
      ) AS BIGINT) / 3600000 AS sla_first_response_elapsed_hours,
      CAST(GET_JSON_OBJECT(
        GET_JSON_OBJECT(fields, customfield_10222.completedCycles),
        ARRAY(0).remainingTime.millis
      ...
      CAST(GET_JSON_OBJECT(GET_JSON_OBJECT(fields, customfield_10221.completedCycles), ARRAY(0).breached) AS BOOLEAN) AS is_sla_resolution_breached,
      CAST(GET_JSON_OBJECT(
        GET_JSON_OBJECT(fields, customfield_10221.completedCycles),
        ARRAY(0).goalDuration.millis
