...
SELECT
  ...
  situation_history,
  next_situation,
  CAST((UNIX_TIMESTAMP(ts_end_situation) - UNIX_TIMESTAMP(ts_start_situation)) / 60 AS BIGINT) AS lead_time_situation_in_minutes,
  CAST((UNIX_TIMESTAMP(ts_end_situation) - UNIX_TIMESTAMP(ts_start_situation)) / 3600 AS BIGINT) AS lead_time_situation_in_hour,
...
SELECT
  ...
  CAST((UNIX_TIMESTAMP(current_date) - UNIX_TIMESTAMP(ts_end_situation)) / 60 AS BIGINT) AS lead_time_situation_in_minutes,
  CAST((UNIX_TIMESTAMP(current_date) - UNIX_TIMESTAMP(ts_end_situation)) / 3600 AS BIGINT) AS lead_time_situation_in_hour,
