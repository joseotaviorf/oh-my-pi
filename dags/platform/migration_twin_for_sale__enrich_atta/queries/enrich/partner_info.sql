SELECT DISTINCT
  COALESCE(id_partner,-1) AS id_partner,
  COALESCE(id_admin_user,-1) AS id_admin_user,
  COALESCE(id_franchise,-1) AS id_franchise,
  COALESCE(id_registration_user,-1) AS id_registration_user,
  partner_name,
  CASE
