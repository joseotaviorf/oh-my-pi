...
SELECT
  (
    'RE-MNPL-I-' || sl.id_finance_entity || '-' || COALESCE(sl.account_number, '')
  ...
  sl.account_number,
  CASE
    WHEN sl.account_number = '420008'
    THEN 'Brokerage (Casa Mineira)'
    WHEN sl.account_number = '420007'
    THEN 'Brokerage (Platform)'
    WHEN sl.account_number = '420032'
    THEN 'Provision - Brokerage (Platform)'
