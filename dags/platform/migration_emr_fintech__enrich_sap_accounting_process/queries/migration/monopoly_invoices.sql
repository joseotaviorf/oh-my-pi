WITH monopoly AS (
  SELECT
    ...
    CASE WHEN sr.id_state_external = '11' THEN '420008' ELSE '420007' END AS account_number,
    CASE
      WHEN sr.id_state_external = '11'
      THEN 'Brokerage (Casa Mineira)'
  ...
  SELECT
    (
      'MNPL-I' || '-' || COALESCE(id_finance_entity_entry, id_finance_entity) || '-' || COALESCE(account_number, '')
