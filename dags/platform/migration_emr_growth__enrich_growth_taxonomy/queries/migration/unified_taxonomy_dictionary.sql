...
FROM (
  SELECT
    ...
    funnel_side,
    dict_source,
    ROW_NUMBER() OVER (PARTITION BY utm_campaign, utm_medium, utm_source ORDER BY dict_source = 'demand' DESC) AS _w
