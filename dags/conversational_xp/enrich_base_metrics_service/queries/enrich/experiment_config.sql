...
FROM VALUES
    ...
    -- Demand concentration v1 Julia Concierge Recs rent experiment
    (
        "ab_beakman_search_services_demand_concentration_v1_julia_concierge_recs_rent_experiment",
        named_struct(
            'begin_date', DATE('2026-08-07'),
            'end_date', NULL,
            'variants', to_json(
                named_struct(
                    '0', 'baseline',
    ...
    -- Sale max price decay score v2
    (
        "ab_beakman_search_services_sale_max_price_decay_score_v2",
        named_struct(
            'begin_date', DATE('2026-07-09'),
            'end_date', NULL,
            'variants', to_json(
                named_struct(
                    '0', 'baseline',
