...
`docs/llm_context` evaluation deployment pipeline. It is not a production
KPI and must not be used for business reporting.
...
**Included:** calendar dates on or after `DATE '2026-02-01'` from
`dw_public.dim_date`.
