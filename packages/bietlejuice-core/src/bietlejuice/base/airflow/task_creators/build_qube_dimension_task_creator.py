"""
Task creator for QUBE dimension build jobs.

Creates Airflow tasks that execute QUBE build_dimension function as Spark jobs on Databricks.
"""
...
class BuildQubeDimensionTaskCreator(BaseTaskCreator):
    """
    Creates the task that builds QUBE dimension tables.
    """
