...
# DAG_PACKAGES_ROOT is defined in dags/__init__.py and is the canonical
# way to reach the dags folder from anywhere in bietlejuice; using it here
# avoids the previous path-distance heuristic on __file__, which broke
# after bietlejuice moved into packages/bietlejuice-airflow/src/.
_DAGS_FOLDER = Path(DAG_PACKAGES_ROOT)
