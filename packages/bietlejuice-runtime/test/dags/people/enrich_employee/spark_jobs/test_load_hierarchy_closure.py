...
class TestLoadBaseRelationships:
    ...
    def test_load_base_relationships_executes_correct_query(
        self, mock_spark_client, mock_dataframe
    ):
    ...
    def test_load_base_relationships_filters_null_managers(
        self, mock_spark_client, mock_dataframe
    ):
    ...
    def test_load_base_relationships_filters_specific_manager(
        self, mock_spark_client, mock_dataframe
    ):
    ...
    def test_load_base_relationships_counts_records(
        self, mock_spark_client, mock_dataframe
    ):
...
class TestInitializeLevel1:
    ...
    def test_initialize_level_1_counts_records(self, mock_dataframe):
        ...
        initialize_level_1(mock_dataframe)
...
class TestBuildLevel:
    ...
    def test_build_level_joins_on_manager_chain(
        self,
        mock_least,
        mock_greatest,
        mock_array,
        ...
        build_level(base_df, previous_level_df, 2)
    ...
    @patch("dags.people.enrich_employee.spark_jobs.load_hierarchy_closure.greatest")
    @patch("dags.people.enrich_employee.spark_jobs.load_hierarchy_closure.least")
    def test_build_level_filters_valid_date_ranges(
        self,
        mock_least,
        mock_greatest,
        mock_array,
        ...
        build_level(base_df, previous_level_df, 3)
    ...
    @patch("dags.people.enrich_employee.spark_jobs.load_hierarchy_closure.greatest")
    @patch("dags.people.enrich_employee.spark_jobs.load_hierarchy_closure.least")
    def test_build_level_counts_output(
        self,
        mock_least,
        mock_greatest,
        mock_array,
...
class TestBuildIterativeHierarchy:
    ...
    @patch(
        "dags.people.enrich_employee.spark_jobs.load_hierarchy_closure.load_base_relationships"
    )
    @patch(
        "dags.people.enrich_employee.spark_jobs.load_hierarchy_closure.initialize_level_1"
    )
    ...
    def test_build_iterative_hierarchy_stops_when_no_records(
        ...
        build_iterative_hierarchy(mock_spark_client)
...
class TestPivotHierarchyToColumns:
    ...
    def test_pivot_hierarchy_reverses_chains(
        self, mock_lit, mock_when, mock_size, mock_reverse, mock_col, mock_dataframe
    ):
        ...
        mock_when.return_value = MagicMock(
            otherwise=MagicMock(return_value=MagicMock())
        )
        ...
        pivot_hierarchy_to_columns(mock_dataframe)
    ...
    @patch("dags.people.enrich_employee.spark_jobs.load_hierarchy_closure.when")
    @patch("dags.people.enrich_employee.spark_jobs.load_hierarchy_closure.lit")
    def test_pivot_hierarchy_creates_level_columns(
        self, mock_lit, mock_when, mock_size, mock_reverse, mock_col, mock_dataframe
    ):
    ...
    @patch("dags.people.enrich_employee.spark_jobs.load_hierarchy_closure.when")
    @patch("dags.people.enrich_employee.spark_jobs.load_hierarchy_closure.lit")
    def test_pivot_hierarchy_selects_final_columns(
        self, mock_lit, mock_when, mock_size, mock_reverse, mock_col, mock_dataframe
    ):
...
class TestConsolidateConsecutivePeriods:
    ...
    def test_consolidate_creates_hierarchy_signature(self, mock_dataframe):
        ...
        consolidate_consecutive_periods(mock_dataframe)
...
class TestAddScdType2Fields:
    ...
    def test_add_scd_adds_version_column(self, mock_dataframe):
        ...
        add_scd_type2_fields(mock_dataframe)
...
class TestSelectFinalColumns:
    ...
    def test_select_final_columns_includes_surrogate_key(self, mock_dataframe):
        ...
        select_final_columns(mock_dataframe)
...
class TestBuildHierarchicalClosure:
    ...
    @patch(
        "dags.people.enrich_employee.spark_jobs.load_hierarchy_closure.build_iterative_hierarchy"
    )
    @patch(
        "dags.people.enrich_employee.spark_jobs.load_hierarchy_closure.pivot_hierarchy_to_columns"
    )
    @patch(
        "dags.people.enrich_employee.spark_jobs.load_hierarchy_closure.consolidate_consecutive_periods"
    )
    @patch(
        "dags.people.enrich_employee.spark_jobs.load_hierarchy_closure.add_scd_type2_fields"
    )
    @patch(
        "dags.people.enrich_employee.spark_jobs.load_hierarchy_closure.select_final_columns"
    )
    def test_build_hierarchical_closure_calls_all_steps(
        ...
        build_hierarchical_closure(mock_spark_client)
    ...
    def test_build_hierarchical_closure_correct_order(
        ...
        mock_consolidate.side_effect = lambda x: (
