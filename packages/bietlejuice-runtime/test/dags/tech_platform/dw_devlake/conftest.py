...
def pull_requests_df(spark):
    ...
    rows = [
        ...
        (
            ...
            "repo-1",
            3150,
            "chore/spark admin backend integration",
            "MERGED",
            "main",
            "type/feature",
            True,
            ...
            "user-1",
            "user-1",
            _ts(2026, 2, 24, 14, 40, 7),
            _ts(2026, 3, 6, 20, 48, 27),
        ),
        ...
        (
            ...
            "user-bot",
            "user-2",
            _ts(2026, 3, 9, 19, 51, 39),
            _ts(2026, 3, 9, 19, 56, 19),
        ),
        ...
        (
            ...
            "user-3",
            "user-3",
            _ts(2026, 2, 12, 3, 47, 49),
            _ts(2026, 2, 12, 23, 14, 8),
        ),
        ...
        (
            ...
            "user-4",
            "user-4",
            _ts(2026, 1, 20, 17, 7, 57),
            _ts(2026, 1, 20, 17, 28, 50),
        ),
        ...
        (
            ...
            "user-5",
            "user-5",
            _ts(2026, 3, 2, 13, 18, 46),
            _ts(2026, 3, 5, 18, 32, 54),
        ),
        ...
        (
            ...
            "user-6",
            "user-6",
            _ts(2026, 1, 23, 19, 33, 38),
            _ts(2026, 1, 24, 1, 2, 38),
        ),
        ...
        (
            ...
            "repo-6",
            1359,
            "feat: add metric for fetch chat",
            "MERGED",
            "main",
            "",
            True,
            ...
            "user-7",
            "user-7",
            _ts(2026, 1, 12, 19, 18, 8),
            _ts(2026, 1, 22, 13, 49, 32),
        ),
        ...
        (
            ...
            "repo-7",
            22479,
            "feat(sync-flow): log HTTP status",
            "MERGED",
            "main",
            "",
            True,
            ...
            "user-8",
            "user-8",
            _ts(2026, 3, 24, 13, 35, 23),
            _ts(2026, 3, 24, 14, 28, 8),
        ),
        ...
        (
            ...
            "repo-7",
            21391,
            "fix: map photo rejection reasons",
            "MERGED",
            "main",
            "",
            True,
            ...
            "user-9",
            "user-9",
            _ts(2026, 3, 10, 16, 27, 31),
            _ts(2026, 3, 11, 12, 43, 56),
        ),
        ...
        (
            ...
            "user-1",
            "user-1",
            _ts(2026, 3, 20, 10, 0, 0),
            _ts(2026, 3, 20, 10, 5, 0),
        ),
        ...
        (
            ...
            "user-5",
            "user-5",
            _ts(2026, 3, 10, 10, 0, 0),
            _ts(2026, 3, 13, 14, 0, 0),
        ),
    ]
...
def pull_request_comments_df(spark):
    ...
    rows = [
        ...
        (
            ...
            "NORMAL",
            "",
            "Ran Plan for dir: infra/",
            _ts(2026, 2, 24, 14, 40, 32),
        ),
        (
            "cmt-a2",
            "pr-A",
        ...
        (
            ...
            "REVIEW",
            "CHANGES_REQUESTED",
            "Needs refactoring before merge",
            _ts(2026, 3, 10, 15, 0, 0),
        ),
        (
            "cmt-l5",
            "pr-L",
